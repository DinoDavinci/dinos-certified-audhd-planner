            ...
            <div className="inspector-rename-modal-body">
              <label className="inspector-rename-field">
                ...
                <div className="inspector-rename-input-row">
                  <input
                    className={renameValidation?.ok ? "inspector-rename-input-ok" : "inspector-rename-input-bad"}
                    value={renameState.name}
                    onChange={(event) => setRenameState((old) => old ? { ...old, name: event.target.value } : old)}
                    autoFocus
                  />
                  <span className={`inspector-rename-extension ${renameValidation?.ok ? "inspector-rename-extension-ok" : "inspector-rename-extension-bad"}`}>.quest.json</span>
                </div>
              </label>
