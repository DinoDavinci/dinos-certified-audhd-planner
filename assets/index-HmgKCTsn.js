...
- Gloves
- Rags
- Correct tools`}),A({id:`obj_oil_drain`,title:`Drain old oil`,description:`Drain the old oil safely.

Remember:
- Let the oil drain fully
- Keep track of the drain plug
- Avoid spills where possible`}),A({id:`obj_oil_filter`,title:`Replace filter`,description:`Replace the oil filter.

Basic reminder:
- Remove old filter
- Check that the old gasket came off
- Install the new filter correctly`}),A({id:`obj_oil_refill`,title:`Refill oil`,description:`Refill with the correct oil.

Check:
- Correct oil type
- Correct amount
- Oil cap replaced afterward`}),A({id:`obj_oil_check`,title:`Check level and leaks`,description:`Verify the oil change.
...
- Top off if needed`})]}),Me({id:`quest_laundry`,title:`Laundry`,description:`Recurring household task for laundry.

Goal:
Move clothes all the way from dirty to put away, not just washed.`,tags:[`Home`],difficulty:`Tiny`,mode:`sequence`,cooldownEnabled:!0,cooldownAmount:1,cooldownUnit:`weeks`,objectives:[A({id:`obj_laundry_sort`,title:`Gather laundry`,description:`Collect laundry from the usual places.

Include:
- Clothes
- Towels
- Washable cloth items
- Anything that needs special handling`}),A({id:`obj_laundry_wash`,title:`Wash`,description:`Start the wash.

Check:
- Load size
- Detergent
- Water temperature
- Any special settings`}),A({id:`obj_laundry_dry`,title:`Dry`,description:`Move laundry out of the washer.

Use dryer or hang dry as needed.

Do not leave wet laundry sitting too long.`}),A({id:`obj_laundry_put_away`,title:`Put away`,description:`Finish the laundry loop.

Checklist:
- Fold or hang
- Pair socks if needed
- Put everything away`})]}),Me({id:`quest_update_website`,title:`Update Website`,description:`Reference quest for publishing changes to the GitHub Pages web version.

Use this when updating the public website.`,tags:[`Release`,`Website`],difficulty:`Tiny`,mode:`sequence`,objectives:[A({id:`obj_web_test_dev`,title:`Test locally`,description:`Verify the browser dev version.
...
- No obvious console errors`}),A({id:`obj_web_test_tauri`,title:`Test desktop dev`,description:`Verify the desktop dev version if the change affects Tauri, localStorage, layout, or file behavior.

Command:
npm run tauri dev`}),A({id:`obj_web_commit`,title:`Commit changes`,description:`Commit and push the source update.

Commands:
git add .
git commit -m "Describe update"
git push origin main`}),A({id:`obj_web_build`,title:`Build website`,description:`Create the production website build.

Command:
npm run build

If this fails, fix the error before deploying.`}),A({id:`obj_web_deploy`,title:`Deploy GitHub Pages`,description:`Publish the built website to GitHub Pages.

Command:
npm run deploy

This updates the gh-pages branch.`}),A({id:`obj_web_verify`,title:`Verify live page`,description:`Verify the live website.
...
Ctrl + Shift + R`})]}),Me({id:`quest_update_appimage`,title:`Update AppImage`,description:`Reference quest for rebuilding the Linux desktop AppImage after changing the app.

Use this when you want a new desktop build.`,tags:[`Release`,`Desktop`],difficulty:`Tiny`,mode:`sequence`,objectives:[A({id:`obj_appimage_export_save`,title:`Export save backup`,description:`Back up your current planner data before a risky update.

Use:
Save/Load → Export JSON`}),A({id:`obj_appimage_test_dev`,title:`Test Tauri dev`,description:`Verify the desktop development version.

Command:
npm run tauri dev

Check that the native window opens and the app behaves normally.`}),A({id:`obj_appimage_build`,title:`Build AppImage`,description:`Build the Linux desktop release.

Command:
npm run tauri build

This may take a while, especially while bundling.`}),A({id:`obj_appimage_find`,title:`Find output`,description:`Find the AppImage output.

Location:
src-tauri/target/release/bundle/appimage/

The file should end with:
.AppImage`}),A({id:`obj_appimage_smoke_test`,title:`Smoke test AppImage`,description:`Smoke test the new AppImage.
...
- Create/edit works
- Save/Load works
- No white screen`})]})],routines:[Ne({id:`routine_simple_workout`,title:`Simple Workout`,description:`A simple starter workout routine.
...
- Rest as needed
- Leave a few reps in reserve`,tags:[`Health`,`Routine`],difficulty:`Medium`,dayMask:ye,mode:`sequence`,active:!0,objectiveTemplate:[A({id:`routine_workout_warmup`,title:`Warmup`,description:`Do a few easy movements to feel warm.

Examples:
- Arm circles
- Hip circles
- Bodyweight squats
- Easy marching in place`}),A({id:`routine_workout_pushups`,title:`Pushups`,description:`Do controlled pushups or incline pushups.

Form notes:
- Keep the body straight
- Lower under control
- Stop before grinding reps`,countTarget:3}),A({id:`routine_workout_squats`,title:`Squats`,description:`Use bodyweight, a dumbbell, or a bag.

Form notes:
- Sit the hips down and back
- Keep knees controlled
- Stand smoothly`,countTarget:3}),A({id:`routine_workout_rows`,title:`Rows`,description:`Use a dumbbell, band, or bag.

Form notes:
- Pull toward the ribs or hip
- Do not yank with momentum
- Lower under control`,countTarget:3}),A({id:`routine_workout_carry`,title:`Carry`,description:`Carry a bag or weight for a short walk.

Form notes:
- Stand tall
- Keep breathing steady
- Do not rush`,countTarget:2})]})]};function bt(e){if(!e||typeof e!=`object`)return yt;let t=Array.isArray(e.quests)?e.quests.map(e=>Me({...e,mode:e.mode||`all`,locked:e.locked??e.sourceType===`routine`,completedAt:e.completedAt||``,cooldownEnabled:e.cooldownEnabled||!1,cooldownAmount:e.cooldownAmount||6,cooldownUnit:e.cooldownUnit||`months`,objectives:ft(e.objectives||[])})):[],n=Array.isArray(e.routines)?e.routines.map(e=>Ne({...e,mode:e.mode||`sequence`,dayMask:e.dayMask??ye,objectiveTemplate:ft(e.objectiveTemplate||[])})):[];return{activeQuestId:e.activeQuestId||t[0]?.id||null,activeBranchObjectiveId:e.activeBranchObjectiveId||null,quests:t,routines:n}}function xt(e){let t=Ce(),n=(e.quests||[]).map(e=>e.sourceType!==`routine`&&e.cooldownEnabled&&j(e)&&e.completedAt&&ke(e.completedAt,e.cooldownAmount,e.cooldownUnit)<=t?{...e,status:`active`,completedAt:``,objectives:Ae(e.objectives||[])}:e).filter(e=>!(e.sourceType===`routine`&&!j(e)&&e.deadline&&e.deadline<t)),r=e.routines||[];for(let e of r)n=Le(n,e);return{...e,quests:n,routines:r}}function St(e){return e?e.type===`quest`?`quest:${e.id}`:e.type===`routine`?`routine:${e.id}`:e.type===`objective`?`objective:${e.questId}:${e.id}`:e.type===`routineObjective`?`routineObjective:${e.routineId}:${e.id}`:`none`:`none`}function Ct(e,t,n){return!e||!n||!t?!1:(t.type===`quest`||t.type===`focus`)&&e.type===`objective`?e.questId===t.quest?.id&&e.id===n.id:t.type===`routine`&&e.type===`routineObjective`?e.routineId===t.routine?.id&&e.id===n.id:!1}function wt(e,t,n){if(e?.type===`routine`){let n=t.routines.find(t=>t.id===e.id);if(n)return{type:`routine`,routine:n,title:`Routine Template: ${n.title}`}}if(e?.type===`routineObjective`){let n=t.routines.find(t=>t.id===e.routineId);if(n)return{type:`routine`,routine:n,title:`Routine Template: ${n.title}`}}if(e?.type===`quest`){let n=t.quests.find(t=>t.id===e.id);if(n)return{type:`quest`,quest:n,title:`Quest Tree: ${n.title}`}}if(e?.type===`objective`){let n=t.quests.find(t=>t.id===e.questId);if(n)return{type:`quest`,quest:n,title:`Quest Tree: ${n.title}`}}return n?{type:`focus`,quest:n,title:`Focus Tree: ${n.title}`}:{type:`empty`,title:`Tree`}}function Tt(e){return e.type===`routine`?`tree-panel routine-tree`:e.type===`quest`||e.type===`focus`?`tree-panel quest-type-regular-tree`:`tree-panel`}function Et(e){return e?e.sourceType===`routine`?`quest-type-routine`:e.cooldownEnabled?`quest-type-cooldown`:`quest-type-regular`:``}function Dt(){let[e,t]=(0,_.useState)(()=>{let e=localStorage.getItem(me),t=yt;if(e)try{t=bt(JSON.parse(e))}catch{t=yt}let n=xt(t);return localStorage.setItem(he,Ce()),n}),[n,r]=(0,_.useState)(`quests`),[i,a]=(0,_.useState)({type:`quest`,id:e.activeQuestId||e.quests[0]?.id||null}),[o,s]=(0,_.useState)([{type:`quest`,id:e.activeQuestId||e.quests[0]?.id||null}]),[c,l]=(0,_.useState)(0),[u,d]=(0,_.useState)(``),[f,p]=(0,_.useState)(`All`),[m,h]=(0,_.useState)(!1),[g,v]=(0,_.useState)({}),[y,b]=(0,_.useState)(!1),[x,ee]=(0,_.useState)(62),[S,C]=(0,_.useState)(360),[te,ne]=(0,_.useState)(430),[re,w]=(0,_.useState)({}),ie=e.quests||[],ae=e.routines||[],oe=ie.find(t=>t.id===e.activeQuestId)||ie[0]||null,se=lt(oe,e.activeBranchObjectiveId),ce=et(se.root?.objectives||[],se.root?.mode||`all`),le=st(at(se.root),oe);function T(e){a(e),s(t=>{let n=t.slice(0,c+1),r=n[n.length-1];if(St(r)===St(e))return t;let i=[...n,e];return l(i.length-1),i})}function E(){if(c<=0)return;let e=c-1;l(e),a(o[e])}function D(){if(c>=o.length-1)return;let e=c+1;l(e),a(o[e])}(0,_.useEffect)(()=>{localStorage.setItem(me,JSON.stringify(e))},[e]),(0,_.useEffect)(()=>{let e=setInterval(()=>{let e=Ce();localStorage.getItem(he)!==e&&(t(e=>xt(e)),localStorage.setItem(he,e))},6e4);return()=>clearInterval(e)},[]);let ue=(0,_.useMemo)(()=>{let e=new Set(ge);return ie.forEach(t=>(t.tags||[]).forEach(t=>e.add(t))),ae.forEach(t=>(t.tags||[]).forEach(t=>e.add(t))),Array.from(e).sort()},[ie,ae]),de=(0,_.useMemo)(()=>ie.filter(e=>`${e.title} ${e.description} ${(e.tags||[]).join(` `)}`.toLowerCase().includes(u.toLowerCase())&&(f===`All`||(e.tags||[]).includes(f))&&(!m||!j(e))).sort((e,t)=>{let n=Number(j(e))-Number(j(t));return n===0?(e.deadline||`9999-99-99`).localeCompare(t.deadline||`9999-99-99`)||e.title.localeCompare(t.title):n}),[ie,u,f,m]),fe=(0,_.useMemo)(()=>ae.filter(e=>`${e.title} ${e.description} ${(e.tags||[]).join(` `)}`.toLowerCase().includes(u.toLowerCase())&&(f===`All`||(e.tags||[]).includes(f))).sort((e,t)=>e.title.localeCompare(t.title)),[ae,u,f]);function pe(){let e=Me({title:`New Quest`});t(t=>({...t,quests:[e,...t.quests]})),T({type:`quest`,id:e.id})}function O(){let e=Ne({title:`New Routine`});t(t=>({...t,routines:[e,...t.routines]})),T({type:`routine`,id:e.id})}function _e(e,n=null){let r=A({title:`New Objective`});t(t=>({...t,quests:t.quests.map(t=>t.id===e?{...t,objectives:gt(t.objectives,n,r)}:t)})),n&&v(e=>({...e,[n]:!0})),T({type:`objective`,questId:e,id:r.id})}function ve(e,n=null){let r=A({title:`New Objective`});t(t=>{let i=null,a=t.routines.map(t=>t.id===e?(i={...t,objectiveTemplate:gt(t.objectiveTemplate,n,r)},i):t);return{...t,routines:a,quests:i?Le(t.quests,i):t.quests}}),n&&v(e=>({...e,[n]:!0})),T({type:`routineObjective`,routineId:e,id:r.id})}function ye(e){t(t=>{let n=t.quests.filter(t=>t.id!==e);return{...t,quests:n,activeQuestId:t.activeQuestId===e?n[0]?.id||null:t.activeQuestId,activeBranchObjectiveId:t.activeQuestId===e?null:t.activeBranchObjectiveId}}),T({type:`none`})}function be(e){t(t=>({...t,quests:t.quests.filter(t=>t.routineId!==e),routines:t.routines.filter(t=>t.id!==e)})),T({type:`none`})}function xe(e,n){t(t=>({...t,quests:t.quests.map(t=>t.id===e?{...t,objectives:_t(t.objectives,n)}:t)})),T({type:`quest`,id:e})}function Se(e,n){t(t=>{let r=null,i=t.routines.map(t=>t.id===e?(r={...t,objectiveTemplate:_t(t.objectiveTemplate,n)},r):t);return{...t,routines:i,quests:r?Le(t.quests,r):t.quests}}),T({type:`routine`,id:e})}function we(e,n,r){t(t=>({...t,quests:t.quests.map(t=>t.id===e?{...t,objectives:vt(t.objectives,n,r)}:t)}))}function Te(e,n,r){t(t=>{let i=null,a=t.routines.map(t=>t.id===e?(i={...t,objectiveTemplate:vt(t.objectiveTemplate,n,r)},i):t);return{...t,routines:a,quests:i?Le(t.quests,i):t.quests}})}function Ee(e,n){t(t=>({...t,quests:t.quests.map(t=>{if(t.id!==e)return t;let r=null,i=ht(t.objectives,n,e=>{if((e.children||[]).length>0&&!qe(e))return e;if(ze(e)&&!e.completed){let{target:t,progress:n}=He(e);return n<t?(r=null,{...e,countProgress:Math.min(t,n+1),completed:!1}):(r=!0,{...e,completed:!0,countProgress:t})}return r=!e.completed,{...e,completed:r,countProgress:r?He(e).progress:0}});return r===!1&&(i=Ye(i,n)),{...t,status:`active`,completedAt:``,objectives:i}})}))}function De(e,n){t(t=>({...t,quests:t.quests.map(t=>{if(t.id!==e)return t;let r=Ye(ht(t.objectives,n,e=>je(e)),n);return{...t,status:`active`,completedAt:``,objectives:r}})}))}function Oe(e){t(t=>({...t,activeQuestId:e,activeBranchObjectiveId:null}))}function ke(e){t(t=>({...t,activeBranchObjectiveId:e}))}function Pe(){t(e=>({...e,activeBranchObjectiveId:null}))}function Fe(e){t(t=>({...t,quests:t.quests.map(t=>t.id!==e||!Xe(t)?t:{...t,status:`completed`,completedAt:Ce()})}))}function Ie(e){t(t=>({...t,quests:t.quests.map(t=>t.id===e?{...t,status:`active`,completedAt:``,objectives:Ae(t.objectives||[])}:t)}))}function Re(){let t={app:`quest-planner`,version:1,exportedAt:new Date().toISOString(),data:e},n=new Blob([JSON.stringify(t,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`),a=Ce();i.href=r,i.download=`quest-planner-${a}.json`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}function Be(e){if(!e)return;let n=new FileReader;n.onload=()=>{try{let e=JSON.parse(String(n.result||`{}`)),r=xt(bt(e?.data&&typeof e.data==`object`?e.data:e));t(r),T({type:`quest`,id:r.activeQuestId||r.quests[0]?.id||null}),s([{type:`quest`,id:r.activeQuestId||r.quests[0]?.id||null}]),l(0),v({}),b(!1),w({}),localStorage.setItem(me,JSON.stringify(r)),localStorage.setItem(he,Ce())}catch{window.alert(`Could not load that JSON file. It may not be a valid quest planner export.`)}},n.readAsText(e)}function Ve(){if(!window.confirm(`Reset all quests and routines to the default state? This clears the saved app data in this browser.`))return;let e=xt(bt(yt));localStorage.removeItem(me),localStorage.removeItem(he),localStorage.setItem(me,JSON.stringify(e)),localStorage.setItem(he,Ce()),t(e),T({type:`quest`,id:e.activeQuestId||e.quests[0]?.id||null}),s([{type:`quest`,id:e.activeQuestId||e.quests[0]?.id||null}]),l(0),v({}),b(!1),w({})}function Ue(){t(e=>xt(e)),localStorage.setItem(he,Ce())}function We(e){let t=Ce();return e?.deadline?e.deadline<t?(0,k.jsx)(`span`,{className:`badge bg-red-950 text-red-200`,children:`Overdue`}):e.deadline===t?(0,k.jsx)(`span`,{className:`badge bg-amber-950 text-amber-200`,children:`Today`}):(0,k.jsxs)(`span`,{className:`badge bg-neutral-800 text-neutral-300`,children:[`Due `,e.deadline]}):null}function Ge(e){e.preventDefault();let t=e.clientX,n=S;function r(e){let r=e.clientX-t;C(Math.min(520,Math.max(240,n+r)))}function i(){window.removeEventListener(`pointermove`,r),window.removeEventListener(`pointerup`,i),document.body.style.userSelect=``,document.body.style.cursor=``}document.body.style.userSelect=`none`,document.body.style.cursor=`col-resize`,window.addEventListener(`pointermove`,r),window.addEventListener(`pointerup`,i)}function Ke(e){e.preventDefault();let t=e.clientX,n=te;function r(e){let r=t-e.clientX;ne(Math.min(620,Math.max(320,n+r)))}function i(){window.removeEventListener(`pointermove`,r),window.removeEventListener(`pointerup`,i),document.body.style.userSelect=``,document.body.style.cursor=``}document.body.style.userSelect=`none`,document.body.style.cursor=`col-resize`,window.addEventListener(`pointermove`,r),window.addEventListener(`pointerup`,i)}return(0,k.jsxs)(`div`,{className:`h-screen overflow-hidden bg-neutral-950 p-4 text-neutral-100`,children:[(0,k.jsxs)(`div`,{className:`app-root`,children:[(0,k.jsx)(Ot,{panelWidth:S,tab:n,setTab:r,search:u,setSearch:d,tagFilter:f,setTagFilter:p,allTags:ue,hideCompleted:m,setHideCompleted:h,quests:de,routines:fe,activeQuestId:e.activeQuestId,dueBadge:We,createQuest:pe,createRoutine:O,exportJson:Re,importJsonFile:Be,resetToDefaults:Ve,selectQuest:e=>T({type:`quest`,id:e.id}),selectRoutine:e=>T({type:`routine`,id:e.id})}),(0,k.jsx)(`div`,{className:`column-splitter`,onPointerDown:Ge,title:`Drag to resize Library`}),(0,k.jsx)(kt,{quest:oe,actionable:ce,focusBoard:le,focusPathInfo:se,branchFocusId:e.activeBranchObjectiveId,setBranchFocus:ke,clearBranchFocus:Pe,dueBadge:We,selectQuest:e=>T({type:`quest`,id:e.id}),selectObjective:e=>T({type:`objective`,questId:oe.id,id:e.id}),toggleObjective:e=>{let t=e.objective||e;return e.kind===`questCompletion`?Fe(oe.id):Ee(oe.id,t.id)},uncompleteObjective:e=>{let t=e.objective||e;return e.kind===`questCompletion`?Ie(oe.id):De(oe.id,t.id)},expandedKanbanCards:re,setExpandedKanbanCards:w}),(0,k.jsx)(`div`,{className:`column-splitter`,onPointerDown:Ke,title:`Drag to resize Inspector / Tree column`}),(0,k.jsx)(Lt,{panelWidth:te,selection:i,data:e,setData:t,setSelection:T,allTags:ue,activeQuest:oe,activeQuestId:e.activeQuestId,expanded:g,setExpanded:v,treeEditMode:y,setTreeEditMode:b,rightSplit:x,setRightSplit:ee,goBack:E,goForward:D,canGoBack:c>0,canGoForward:c<o.length-1,makeFocus:Oe,activeQuestId:e.activeQuestId,activeBranchObjectiveId:e.activeBranchObjectiveId,setBranchFocus:ke,clearBranchFocus:Pe,completeQuest:Fe,restoreQuest:Ie,createQuestObjective:_e,createRoutineObjective:ve,deleteQuest:ye,deleteRoutine:be,deleteQuestObjective:xe,deleteRoutineObjective:Se,moveQuestObjective:we,moveRoutineObjective:Te,toggleObjective:Ee,runMaintenanceNow:Ue})]}),(0,k.jsx)(pn,{})]})}function Ot({panelWidth:e,tab:t,setTab:n,search:r,setSearch:i,tagFilter:a,setTagFilter:o,allTags:s,hideCompleted:c,setHideCompleted:l,quests:u,routines:d,activeQuestId:f,dueBadge:p,createQuest:m,createRoutine:h,exportJson:g,importJsonFile:_,resetToDefaults:v,selectQuest:y,selectRoutine:b}){return(0,k.jsxs)(`section`,{className:`panel panel-scroll library-col`,style:{flexBasis:`${e}px`},children:[(0,k.jsx)(an,{tab:t,setTab:n}),(0,k.jsxs)(`div`,{className:`panel-content`,children:[t!==`save`&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(`div`,{className:`mt-4 space-y-2`,children:[(0,k.jsxs)(`div`,{className:`relative`,children:[(0,k.jsx)(de,{className:`absolute left-3 top-2.5 text-neutral-500`,size:16}),(0,k.jsx)(`input`,{className:`field py-2 pl-9`,value:r,onChange:e=>i(e.target.value),placeholder:``})]}),(0,k.jsxs)(`select`,{className:`field py-2`,value:a,onChange:e=>o(e.target.value),children:[(0,k.jsx)(`option`,{children:`All`}),s.map(e=>(0,k.jsx)(`option`,{children:e},e))]}),t===`quests`&&(0,k.jsxs)(`label`,{className:`flex items-center gap-2 rounded-xl border border-neutral-700 bg-neutral-950 px-3 py-2 text-sm text-neutral-300`,children:[(0,k.jsx)(`input`,{type:`checkbox`,checked:c,onChange:e=>l(e.target.checked)}),`Hide complete`]})]}),(0,k.jsx)(`div`,{className:`mt-4`,children:t===`quests`?(0,k.jsxs)(`button`,{onClick:m,className:`primary-button w-full`,children:[(0,k.jsx)(D,{size:18}),` New quest`]}):(0,k.jsxs)(`button`,{onClick:h,className:`primary-button w-full`,children:[(0,k.jsx)(D,{size:18}),` New routine`]})}),(0,k.jsxs)(`div`,{className:`mt-4 space-y-3`,children:[t===`quests`&&u.map(e=>(0,k.jsxs)(`button`,{onClick:()=>y(e),className:`library-card text-left ${Et(e)} ${j(e)?`library-card-complete`:``} ${e.id===f?`border-neutral-300 bg-neutral-800`:``}`,children:[(0,k.jsxs)(`div`,{className:`flex items-start justify-between gap-3`,children:[(0,k.jsx)(`div`,{className:`font-semibold`,children:e.title}),p(e)]}),(0,k.jsx)(`div`,{className:`mt-2 h-2 overflow-hidden rounded-full bg-neutral-800`,children:(0,k.jsx)(`div`,{className:`h-full bg-slate-200`,style:{width:`${$e(e)}%`}})}),(0,k.jsxs)(`div`,{className:`mt-3 flex flex-wrap gap-2`,children:[j(e)&&(0,k.jsx)(`span`,{className:`pill-complete`,children:`Completed`}),(e.tags||[]).map(e=>(0,k.jsx)(`span`,{className:`pill`,children:e},e)),e.sourceType===`routine`&&(0,k.jsx)(`span`,{className:`pill-blue`,children:`Routine`})]})]},e.id)),t===`routines`&&d.map(e=>(0,k.jsxs)(`button`,{onClick:()=>b(e),className:`library-card text-left`,children:[(0,k.jsxs)(`div`,{className:`flex items-start justify-between gap-3`,children:[(0,k.jsx)(`div`,{className:`font-semibold`,children:e.title}),(0,k.jsx)(`span`,{className:e.active?`pill-green`:`pill-red`,children:e.active?`Active`:`Paused`})]}),(0,k.jsx)(`div`,{className:`mt-1 text-sm text-neutral-400`,children:Ee(e.dayMask)}),(0,k.jsx)(`div`,{className:`mt-3 flex flex-wrap gap-2`,children:(e.tags||[]).map(e=>(0,k.jsx)(`span`,{className:`pill`,children:e},e))})]},e.id))]})]}),t===`save`&&(0,k.jsxs)(`div`,{className:`mt-4 space-y-3`,children:[(0,k.jsx)(`button`,{type:`button`,onClick:g,className:`primary-button w-full justify-center`,children:`Export JSON`}),(0,k.jsxs)(`label`,{className:`primary-button w-full cursor-pointer justify-center`,children:[`Load JSON`,(0,k.jsx)(`input`,{type:`file`,accept:`application/json,.json`,className:`hidden`,onChange:e=>{_(e.target.files?.[0]),e.target.value=``}})]}),(0,k.jsx)(`button`,{type:`button`,onClick:v,className:`danger-button w-full justify-center`,children:`Reset to defaults`}),(0,k.jsx)(`div`,{className:`rounded border border-neutral-800 bg-neutral-950 p-3 text-sm text-neutral-400`,children:`Export creates a backup file of your quests and routines. Load replaces the current app state with the selected JSON file. Reset clears saved data and restores the default quests/routines.`})]})]})]})}function kt({quest:e,actionable:t,focusBoard:n,focusPathInfo:r,branchFocusId:i,setBranchFocus:a,clearBranchFocus:o,dueBadge:s,selectQuest:c,selectObjective:l,toggleObjective:u,uncompleteObjective:d,expandedKanbanCards:f,setExpandedKanbanCards:p}){return e?(0,k.jsxs)(`main`,{className:`panel panel-scroll focus-col`,children:[(0,k.jsx)(on,{title:`Current Focus`}),(0,k.jsxs)(`div`,{className:`panel-content focus-panel-content`,children:[(0,k.jsx)(Pt,{quest:e,focusPathInfo:r,selectQuest:c,selectObjective:l,setBranchFocus:a,clearBranchFocus:o}),n.available.some(e=>e.kind===`questCompletion`)||j(e)?(0,k.jsx)(`div`,{className:`complete-quest-celebration`,children:(0,k.jsxs)(`button`,{onClick:()=>{let e=n.available.find(e=>e.kind===`questCompletion`);e&&u(e)},className:j(e)?`recommended-complete-quest-button recommended-complete-quest-button-done`:`recommended-complete-quest-button`,disabled:j(e),children:[(0,k.jsx)(`span`,{className:`complete-quest-icon`,children:`◆`}),(0,k.jsx)(`span`,{className:`complete-quest-label`,children:j(e)?`Quest completed`:`Complete quest`}),(0,k.jsx)(`span`,{className:`complete-quest-icon`,children:`◆`})]})}):(0,k.jsxs)(`section`,{className:`mt-5 focus-recommend-panel`,children:[(0,k.jsx)(`h3`,{className:`text-lg font-bold`,children:`Recommended`}),n.recommended?(0,k.jsxs)(`div`,{className:`recommended-task-row`,children:[(0,k.jsxs)(`div`,{className:`recommended-task-text`,children:[(0,k.jsx)(Ft,{row:n.recommended,selectObjective:l}),n.recommended.objective.description&&(0,k.jsx)(`div`,{className:`mt-1 text-sm text-neutral-400`,children:n.recommended.objective.description})]}),(0,k.jsxs)(`button`,{onClick:()=>u(n.recommended),className:`primary-button recommended-action-button`,children:[Ge(n.recommended.objective)===`progress`?(0,k.jsx)(E,{size:16}):(0,k.jsx)(T,{size:16}),Ge(n.recommended.objective)===`progress`?`Progress`:`Complete`]})]}):(0,k.jsx)(`div`,{className:`mt-2 text-sm text-neutral-500`,children:`No available objective. This quest may be complete.`})]}),(0,k.jsxs)(`div`,{className:`branch-progress-line`,children:[(0,k.jsxs)(`div`,{className:`branch-progress-label`,children:[(0,k.jsx)(`span`,{children:`Progress`}),(0,k.jsxs)(`span`,{children:[Number.isFinite(r.progress)?r.progress:0,`%`]})]}),(0,k.jsx)(`div`,{className:`branch-progress-track`,children:(0,k.jsx)(`div`,{className:`branch-progress-fill`,style:{width:`${Number.isFinite(r.progress)?r.progress:0}%`}})})]}),(0,k.jsxs)(`section`,{className:`mt-5 focus-board`,children:[(0,k.jsx)(It,{title:`Available`,rows:n.available,emptyText:`No available objectives.`,selectObjective:l,toggleObjective:u,expandedKanbanCards:f,setExpandedKanbanCards:p,showCompleteButton:!0}),(0,k.jsx)(It,{title:`In Progress`,rows:n.inProgress,emptyText:`No parent objectives in progress.`,selectObjective:l,expandedKanbanCards:f,setExpandedKanbanCards:p,showProgress:!0}),(0,k.jsx)(It,{title:`Completed`,rows:n.completed,emptyText:`Nothing completed yet.`,selectObjective:l,uncompleteObjective:d,expandedKanbanCards:f,setExpandedKanbanCards:p,completed:!0,showUncompleteButton:!0,summary:`${n.completedCount} / ${n.totalCount}`})]})]})]}):(0,k.jsxs)(`main`,{className:`panel panel-scroll focus-col`,children:[(0,k.jsx)(on,{title:`Current Focus`}),(0,k.jsx)(`div`,{className:`panel-content text-neutral-400`,children:`Create or select a quest, then make it the current focus.`})]})}function At(e,t){return e?t?.branchObjective||e:null}function jt(e,t){return e?[{id:e.id,title:e.title||`Untitled quest`,type:`quest`},...(t?.path||[]).map(e=>({id:e.id,title:e.title||`Untitled`,type:`objective`}))]:[]}function Mt({quest:e,focusPathInfo:t,selectQuest:n,setBranchFocus:r,clearBranchFocus:i}){let a=jt(e,t);return(0,k.jsxs)(`div`,{className:`focus-directory-path`,children:[(0,k.jsx)(`span`,{className:`focus-relation-label`,children:`Path:`}),a.map((e,t)=>(0,k.jsxs)(_.Fragment,{children:[t>0&&(0,k.jsx)(`span`,{className:`focus-directory-separator`,children:`›`}),(0,k.jsx)(`button`,{className:`focus-directory-link`,onClick:()=>{e.type===`quest`?i():r(e.id)},children:e.title})]},`${e.type}-${e.id}`))]})}function Nt({quest:e,focusPathInfo:t,setBranchFocus:n,clearBranchFocus:r,selectQuest:i}){let a=t?.childBranches||[];return(0,k.jsx)(`div`,{className:`focus-relations`,children:(0,k.jsxs)(`div`,{className:`focus-relation-line`,children:[(0,k.jsx)(`span`,{className:`focus-relation-label`,children:`Subquests:`}),a.length===0&&(0,k.jsx)(`span`,{className:`focus-relation-muted`,children:`No subquests`}),a.map(e=>(0,k.jsx)(`button`,{type:`button`,className:`focus-relation-chip`,onClick:()=>n(e.id),children:e.title||`Untitled`},e.id))]})})}function Pt({quest:e,focusPathInfo:t,selectQuest:n,selectObjective:r,setBranchFocus:i,clearBranchFocus:a}){let o=At(e,t),s=o?.description||``;return(0,k.jsxs)(`div`,{className:`focus-document-header`,children:[(0,k.jsx)(`button`,{className:`focus-document-title focus-document-title-button`,onClick:()=>{t?.branchObjective?r(t.branchObjective):n(e)},title:`Select in inspector`,children:o?.title||`Untitled`}),(t?.path||[]).length>0&&(0,k.jsx)(Mt,{quest:e,focusPathInfo:t,selectQuest:n,setBranchFocus:i,clearBranchFocus:a}),(0,k.jsx)(Nt,{quest:e,focusPathInfo:t,setBranchFocus:i,clearBranchFocus:a,selectQuest:n}),s.trim()!==``&&(0,k.jsxs)(`div`,{className:`focus-description-section`,children:[(0,k.jsx)(`h3`,{className:`focus-description-title`,children:`Description`}),(0,k.jsx)(`p`,{className:`focus-description-text`,children:s})]})]})}function Ft({row:e,selectObjective:t}){return(0,k.jsx)(`div`,{className:`focus-path-links`,children:e.path.map((n,r)=>(0,k.jsxs)(_.Fragment,{children:[r>0&&(0,k.jsx)(`span`,{className:`focus-path-separator`,children:`›`}),(0,k.jsx)(`button`,{className:`focus-path-link`,onClick:r=>{r.stopPropagation(),e.kind!==`questCompletion`&&t(n)},title:`Select in inspector`,children:r===e.path.length-1&&e.displayTitle?e.displayTitle:n.title||`Untitled`})]},n.id))})}function It({title:e,rows:t,emptyText:n,selectObjective:r,toggleObjective:i,uncompleteObjective:a,expandedKanbanCards:o={},setExpandedKanbanCards:s,showCompleteButton:c=!1,showUncompleteButton:l=!1,showProgress:u=!1,completed:d=!1,summary:f=null}){return(0,k.jsxs)(`div`,{className:`focus-column`,children:[(0,k.jsxs)(`div`,{className:`focus-column-title`,children:[(0,k.jsx)(`span`,{children:e}),(0,k.jsx)(`span`,{className:`focus-column-count`,children:f||t.length})]}),(0,k.jsxs)(`div`,{className:`focus-column-list`,children:[t.length===0&&(0,k.jsx)(`div`,{className:`focus-empty`,children:n}),t.map(e=>{let t=!!(e.objective.description||``).trim(),n=!!o[e.objective.id];return(0,k.jsxs)(`div`,{className:d?`focus-card focus-card-complete`:`focus-card`,children:[(0,k.jsxs)(`div`,{className:`focus-card-bar`,onClick:()=>e.kind!==`questCompletion`&&r(e.objective),role:`button`,tabIndex:0,onKeyDown:t=>{(t.key===`Enter`||t.key===` `)&&(t.preventDefault(),e.kind!==`questCompletion`&&r(e.objective))},children:[(0,k.jsxs)(`div`,{className:`focus-card-main`,children:[(0,k.jsxs)(`div`,{className:`focus-card-title-line`,children:[t&&(0,k.jsx)(`button`,{onClick:t=>{t.stopPropagation(),s?.(t=>({...t,[e.objective.id]:!t[e.objective.id]}))},className:`focus-card-done focus-card-dropdown`,title:n?`Hide description`:`Show description`,children:n?(0,k.jsx)(ce,{size:14}):(0,k.jsx)(le,{size:14})}),(0,k.jsx)(Ft,{row:e,selectObjective:r})]}),u&&e.progress&&(0,k.jsx)(`div`,{className:`focus-card-progress-bar`,title:`${e.progress.complete} / ${e.progress.total}`,children:(0,k.jsx)(`div`,{className:`focus-card-progress-fill`,style:{width:`${e.progress.total>0?Math.round(e.progress.complete/e.progress.total*100):0}%`}})})]}),(0,k.jsxs)(`div`,{className:`focus-card-actions`,children:[c&&(0,k.jsx)(`button`,{onClick:t=>{t.stopPropagation(),i(e)},className:`focus-card-done ${Ge(e.objective)===`progress`?`focus-card-action-progress`:`focus-card-action-complete`}`,title:Ke(e.objective),children:Ge(e.objective)===`progress`?(0,k.jsx)(E,{size:14}):(0,k.jsx)(T,{size:14})}),l&&(0,k.jsx)(`button`,{onClick:t=>{t.stopPropagation(),a(e)},className:`focus-card-done focus-card-action-uncomplete`,title:`Mark incomplete`,children:(0,k.jsx)(pe,{size:14})})]})]}),ze(e.objective)&&!e.objective.completed&&(0,k.jsx)(`div`,{className:`focus-card-progress-bar focus-card-progress-full`,title:`${He(e.objective).progress} / ${He(e.objective).target}`,children:(0,k.jsx)(`div`,{className:`focus-card-progress-fill`,style:{width:`${Ue(e.objective)}%`}})}),t&&n&&(0,k.jsx)(`div`,{className:`focus-card-body`,children:e.objective.description})]},e.objective.id)})]})]})}function Lt(e){let{panelWidth:t,selection:n,data:r,activeQuest:i,expanded:a,setExpanded:o,treeEditMode:s,setTreeEditMode:c,rightSplit:l,setRightSplit:u,setSelection:d,createQuestObjective:f,createRoutineObjective:p,deleteQuestObjective:m,deleteRoutineObjective:h,moveQuestObjective:g,moveRoutineObjective:v,toggleObjective:y}=e,b=wt(n,r,i),x=b.quest?.locked?!1:s,ee=(0,_.useRef)(null);function S(e){e.preventDefault();let t=e.clientY,n=l,r=ee.current?.getBoundingClientRect()?.height||1;function i(e){let i=(e.clientY-t)/r*100;u(Math.min(82,Math.max(28,n+i)))}function a(){window.removeEventListener(`pointermove`,i),window.removeEventListener(`pointerup`,a),document.body.style.userSelect=``,document.body.style.cursor=``}document.body.style.userSelect=`none`,document.body.style.cursor=`row-resize`,window.addEventListener(`pointermove`,i),window.addEventListener(`pointerup`,a)}return(0,k.jsxs)(`aside`,{className:`right-column`,ref:ee,style:{flexBasis:`${t}px`},children:[(0,k.jsxs)(`section`,{className:`panel panel-scroll inspector-panel`,style:{flexBasis:`${l}%`},children:[(0,k.jsx)(Vt,{...e}),(0,k.jsx)(`div`,{className:`panel-content`,children:(0,k.jsx)(Ht,{...e})})]}),(0,k.jsx)(`div`,{className:`right-splitter`,onPointerDown:S,title:`Drag to resize Inspector / Tree View`}),(0,k.jsxs)(`section`,{className:`panel panel-scroll ${Tt(b)}`,style:{flexBasis:`${100-l}%`},children:[(0,k.jsxs)(on,{title:`Tree View`,children:[x&&b.type===`routine`&&(0,k.jsx)(`button`,{onClick:()=>p(b.routine.id,null),className:`title-secondary-button`,children:`+ Objective`}),x&&(b.type===`quest`||b.type===`focus`)&&b.quest&&!b.quest.locked&&(0,k.jsx)(`button`,{onClick:()=>f(b.quest.id,null),className:`title-secondary-button`,children:`+ Objective`}),(0,k.jsx)(`button`,{onClick:()=>!b.quest?.locked&&c(!s),disabled:!!b.quest?.locked,className:b.quest?.locked?`title-secondary-button title-button-disabled`:x?`title-primary-button`:`title-secondary-button`,title:b.quest?.locked?`Routine-generated quests are read-only. Edit the source routine instead.`:`Edit tree`,children:x?`Done`:`Edit`})]}),(0,k.jsxs)(`div`,{className:`panel-content`,children:[b.type===`routine`&&(0,k.jsx)(en,{title:b.routine.title,kind:`routine`,selected:n.type===`routine`&&n.id===b.routine.id,onSelect:()=>!s&&d({type:`routine`,id:b.routine.id})}),(b.type===`quest`||b.type===`focus`)&&b.quest&&(0,k.jsx)(en,{title:b.quest.title,kind:`root-${b.type,Et(b.quest)}`,selected:n.type===`quest`&&n.id===b.quest.id,onSelect:()=>!s&&d({type:`quest`,id:b.quest.id})}),b.type===`routine`&&(0,k.jsx)(tn,{objectives:b.routine.objectiveTemplate,expanded:a,setExpanded:o,onSelect:e=>d({type:`routineObjective`,routineId:b.routine.id,id:e.id}),onAddChild:e=>p(b.routine.id,e.id),onDelete:e=>h(b.routine.id,e.id),onMoveUp:e=>v(b.routine.id,e.id,-1),onMoveDown:e=>v(b.routine.id,e.id,1),onToggleComplete:()=>{},treeEditMode:x,selection:n,treeContext:b,template:!0}),(b.type===`quest`||b.type===`focus`)&&b.quest&&(0,k.jsx)(tn,{objectives:b.quest.objectives,expanded:a,setExpanded:o,onSelect:e=>d({type:`objective`,questId:b.quest.id,id:e.id}),onAddChild:e=>f(b.quest.id,e.id),onDelete:e=>m(b.quest.id,e.id),onMoveUp:e=>g(b.quest.id,e.id,-1),onMoveDown:e=>g(b.quest.id,e.id,1),onToggleComplete:e=>y(b.quest.id,e.id),treeEditMode:x,selection:n,treeContext:b}),b.type===`empty`&&(0,k.jsx)(`div`,{className:`text-sm text-neutral-500`,children:`No quest or routine selected.`})]})]})]})}function Rt(e){let t=e?.type||`none`;return t===`quest`?`Quest`:t===`routine`?`Routine`:t===`objective`?`Objective`:t===`routineObjective`?`Template Objective`:`Nothing`}function zt(e){let t=e?.type||`none`;return t===`quest`?`inspector-title-quest`:t===`routine`?`inspector-title-routine`:t===`objective`?`inspector-title-objective`:t===`routineObjective`?`inspector-title-routineObjective`:``}function Bt(e,t,n,r){if(!e||!t)return null;if(e.type===`quest`){let i=t.quests.find(t=>t.id===e.id);if(!i)return null;let a=n===i.id&&!r;return{label:`Focus`,disabled:a,title:a?`Already focused here`:`Focus this quest`,actionType:`quest`,questId:i.id}}if(e.type===`objective`){let i=t.quests.find(t=>t.id===e.questId);if(!i)return null;let a=pt(i.objectives||[],e.id)||[];if(!a[a.length-1])return null;let o=[...a].reverse().find(e=>(e.children||[]).length>0);if(o){let e=n===i.id&&r===o.id;return{label:`Focus`,disabled:e,title:e?`Already focused here`:`Focus nearest branch`,actionType:`objective`,questId:i.id,objectiveId:o.id}}let s=n===i.id&&!r;return{label:`Focus`,disabled:s,title:s?`Already focused here`:`Focus owner quest`,actionType:`quest`,questId:i.id}}return null}function Vt({selection:e,data:t,activeQuestId:n,activeBranchObjectiveId:r,makeFocus:i,setBranchFocus:a,goBack:o,goForward:s,canGoBack:c,canGoForward:l}){let u=Bt(e,t,n,r);function d(){!u||u.disabled||(u.actionType===`quest`&&i(u.questId),u.actionType===`objective`&&(i(u.questId),a(u.objectiveId)))}return(0,k.jsxs)(on,{title:`Inspector - ${Rt(e)}`,className:zt(e),children:[(0,k.jsx)(`button`,{onClick:o,disabled:!c,className:`title-icon-button disabled:opacity-30`,children:(0,k.jsx)(ae,{size:16})}),(0,k.jsx)(`button`,{onClick:s,disabled:!l,className:`title-icon-button disabled:opacity-30`,children:(0,k.jsx)(oe,{size:16})}),u&&(0,k.jsx)(`button`,{onClick:d,disabled:u.disabled,className:`title-secondary-button`,title:u.title,children:`Focus`})]})}function Ht({selection:e,data:t,setData:n,setSelection:r,allTags:i,activeQuestId:a,goBack:o,goForward:s,canGoBack:c,canGoForward:l,makeFocus:u,activeBranchObjectiveId:d,setBranchFocus:f,clearBranchFocus:p,completeQuest:m,restoreQuest:h,createQuestObjective:g,createRoutineObjective:_,deleteQuest:v,deleteRoutine:y,deleteQuestObjective:b,deleteRoutineObjective:x,toggleObjective:ee,runMaintenanceNow:S}){let C=Ut(e,t);return Wt(e,C),(0,k.jsxs)(`div`,{children:[e.type===`quest`&&C?.quest&&(0,k.jsx)(Gt,{quest:C.quest,allTags:i,isFocus:C.quest.id===a&&!d,isQuestRoot:C.quest.id===a,activeBranchObjectiveId:d,setData:n,routines:t.routines||[],setSelection:r,makeFocus:()=>u(C.quest.id),completeQuest:()=>m(C.quest.id),restoreQuest:()=>h(C.quest.id),deleteQuest:()=>v(C.quest.id)}),e.type===`routine`&&C?.routine&&(0,k.jsx)(Kt,{routine:C.routine,allTags:i,setData:n,deleteRoutine:()=>y(C.routine.id),runMaintenanceNow:S}),e.type===`objective`&&C?.quest&&C?.objective&&(0,k.jsx)(Xt,{objective:C.objective,parent:C.parent,ownerTitle:C.quest.title,ancestry:mt(e,t),setSelection:r,locked:C.quest.locked,canFocusBranch:C.quest.id===a&&(C.objective.children||[]).length>0,isBranchFocused:d===C.objective.id,setBranchFocus:()=>f(C.objective.id),clearBranchFocus:p,updateObjective:t=>{n(n=>({...n,quests:n.quests.map(n=>n.id===C.quest.id?{...n,objectives:ht(n.objectives,e.id,t)}:n)}))},toggleComplete:()=>ee(C.quest.id,C.objective.id),template:!1}),e.type===`routineObjective`&&C?.routine&&C?.objective&&(0,k.jsx)(Xt,{objective:C.objective,parent:C.parent,ownerTitle:C.routine.title,ancestry:mt(e,t),setSelection:r,locked:!1,updateObjective:t=>{n(n=>{let r=null,i=n.routines.map(n=>n.id===C.routine.id?(r={...n,objectiveTemplate:ht(n.objectiveTemplate,e.id,t)},r):n);return{...n,routines:i,quests:r?Le(n.quests,r):n.quests}})},template:!0}),(!C||e.type===`none`)&&(0,k.jsx)(`div`,{className:`rounded-2xl border border-neutral-800 bg-neutral-950 p-4 text-neutral-400`,children:`Select an item from the library or focus tree.`})]})}function Ut(e,t){if(!e||e.type===`none`)return null;if(e.type===`quest`)return{quest:t.quests.find(t=>t.id===e.id)};if(e.type===`routine`)return{routine:t.routines.find(t=>t.id===e.id)};if(e.type===`objective`){let n=t.quests.find(t=>t.id===e.questId),r=n?M(n.objectives,e.id):null;return{quest:n,objective:r?.objective,parent:r?.parent}}if(e.type===`routineObjective`){let n=t.routines.find(t=>t.id===e.routineId),r=n?M(n.objectiveTemplate,e.id):null;return{routine:n,objective:r?.objective,parent:r?.parent}}return null}function Wt(e,t){return e.type===`quest`&&t?.quest?`Quest: ${t.quest.title||`Untitled`}`:e.type===`routine`&&t?.routine?`Routine: ${t.routine.title||`Untitled`}`:e.type===`objective`&&t?.objective?`Objective: ${t.objective.title||`Untitled`}`:e.type===`routineObjective`&&t?.objective?`Template Objective: ${t.objective.title||`Untitled`}`:`Nothing selected`}function Gt({quest:e,allTags:t,isFocus:n,isQuestRoot:r=!1,activeBranchObjectiveId:i=null,setData:a,routines:o,setSelection:s,makeFocus:c,completeQuest:l,restoreQuest:u,deleteQuest:d}){function f(t){e.locked||a(n=>({...n,quests:n.quests.map(n=>n.id===e.id?{...n,...t}:n)}))}let p=j(e),m=!!e.completedAt,h=(o||[]).find(t=>t.id===e.routineId);return(0,k.jsxs)(`div`,{className:`space-y-4`,children:[(0,k.jsx)(`div`,{className:`wiki-meta-block`,children:(0,k.jsx)(Zt,{quest:e,setSelection:s})}),(0,k.jsx)(`div`,{className:`main-action-row`,children:(0,k.jsx)(Jt,{progress:$e(e),label:`Complete quest`,readyLabel:`Complete quest`,complete:p&&m,completeLabel:`Reopen quest`,onComplete:l,onReopen:u,disabled:!Xe(e),disabledTitle:`Complete all root objectives first.`})}),(0,k.jsx)(qt,{progress:$e(e),label:`Quest progress`}),e.locked&&(0,k.jsxs)(`div`,{className:`locked-notice`,children:[`This is a read-only instance generated from a routine.`,h&&(0,k.jsx)(`button`,{className:`wiki-link-button ml-1`,onClick:()=>s({type:`routine`,id:h.id}),children:`Edit source routine`})]}),(0,k.jsx)(cn,{label:`Title`,value:e.title,onChange:e=>f({title:e}),disabled:e.locked}),(0,k.jsx)(ln,{label:`Description`,value:e.description,onChange:e=>f({description:e}),disabled:e.locked}),(0,k.jsx)(rn,{tags:e.tags||[],allTags:t,onChange:e=>f({tags:e}),disabled:e.locked}),(0,k.jsxs)(`div`,{className:`grid grid-cols-2 gap-3`,children:[(0,k.jsx)(fn,{label:`Difficulty`,value:e.difficulty,options:_e,onChange:e=>f({difficulty:e}),disabled:e.locked}),(0,k.jsx)(fn,{label:`Rule`,value:e.mode,options:be,onChange:e=>f({mode:e}),disabled:e.locked})]}),(0,k.jsx)(dn,{label:`Deadline`,value:e.deadline,onChange:e=>f({deadline:e}),disabled:e.locked}),!e.locked&&(0,k.jsxs)(`div`,{className:`cooldown-box`,children:[(0,k.jsxs)(`label`,{className:`flex items-center gap-2 text-sm text-neutral-300`,children:[(0,k.jsx)(`input`,{type:`checkbox`,checked:e.cooldownEnabled,onChange:e=>f({cooldownEnabled:e.target.checked})}),`Reset after cooldown`]}),e.cooldownEnabled&&(0,k.jsxs)(`div`,{className:`mt-3 grid grid-cols-2 gap-3`,children:[(0,k.jsx)(un,{label:`Cooldown amount`,value:e.cooldownAmount,onChange:e=>f({cooldownAmount:e})}),(0,k.jsx)(fn,{label:`Cooldown unit`,value:e.cooldownUnit,options:xe,onChange:e=>f({cooldownUnit:e})})]}),e.cooldownEnabled&&e.completedAt&&(0,k.jsxs)(`div`,{className:`mt-2 text-xs text-neutral-400`,children:[`Completed `,e.completedAt,`. Resets after `,e.cooldownAmount,` `,e.cooldownUnit,`.`]})]}),(0,k.jsxs)(`div`,{className:`rounded-2xl border border-neutral-800 bg-neutral-950 p-4`,children:[(0,k.jsxs)(`div`,{className:`mb-2 flex justify-between text-sm`,children:[(0,k.jsx)(`span`,{className:`text-neutral-400`,children:`Progress`}),(0,k.jsxs)(`span`,{children:[$e(e),`%`]})]}),(0,k.jsx)(`div`,{className:`h-3 overflow-hidden rounded-full bg-neutral-800`,children:(0,k.jsx)(`div`,{className:`h-full rounded-full bg-slate-200`,style:{width:`${$e(e)}%`}})})]}),(0,k.jsx)(`div`,{className:`danger-zone`,children:(0,k.jsxs)(`button`,{onClick:d,disabled:e.locked,className:`danger-button w-full disabled:opacity-40 disabled:cursor-not-allowed`,title:e.locked?`Routine-generated quests cannot be deleted from the quest inspector.`:`Delete quest`,children:[(0,k.jsx)(fe,{size:16}),` Delete quest`]})})]})}function Kt({routine:e,allTags:t,setData:n,deleteRoutine:r,runMaintenanceNow:i}){function a(t){n(n=>{let r={...e,...t};return{...n,routines:n.routines.map(t=>t.id===e.id?r:t),quests:Le(n.quests,r)}})}return(0,k.jsxs)(`div`,{className:`space-y-4`,children:[(0,k.jsx)(`div`,{className:`main-action-row`}),(0,k.jsx)(cn,{label:`Title`,value:e.title,onChange:e=>a({title:e})}),(0,k.jsx)(ln,{label:`Description`,value:e.description,onChange:e=>a({description:e})}),(0,k.jsx)(rn,{tags:e.tags||[],allTags:t,onChange:e=>a({tags:e})}),(0,k.jsxs)(`div`,{className:`grid grid-cols-2 gap-3`,children:[(0,k.jsx)(fn,{label:`Difficulty`,value:e.difficulty,options:_e,onChange:e=>a({difficulty:e})}),(0,k.jsx)(fn,{label:`Quest rule`,value:e.mode,options:be,onChange:e=>a({mode:e})})]}),(0,k.jsx)(nn,{label:`Active days`,value:e.dayMask??ye,onChange:e=>a({dayMask:e})}),(0,k.jsxs)(`label`,{className:`flex items-center gap-2 text-sm text-neutral-300`,children:[(0,k.jsx)(`input`,{type:`checkbox`,checked:e.active,onChange:e=>a({active:e.target.checked})}),`Active`]}),(0,k.jsx)(`div`,{className:`danger-zone`,children:(0,k.jsxs)(`button`,{onClick:r,className:`danger-button w-full`,children:[(0,k.jsx)(fe,{size:16}),` Delete routine`]})})]})}function qt({progress:e,label:t=`Progress`,detail:n=``}){let r=Number.isFinite(e)?Math.max(0,Math.min(100,e)):0;return(0,k.jsxs)(`div`,{className:`inspector-progress-block`,children:[(0,k.jsxs)(`div`,{className:`inspector-progress-header`,children:[(0,k.jsx)(`span`,{children:t}),(0,k.jsx)(`span`,{children:n||`${r}%`})]}),(0,k.jsx)(`div`,{className:`inspector-progress-bar`,children:(0,k.jsx)(`div`,{className:`inspector-progress-fill`,style:{width:`${r}%`}})})]})}function Jt({progress:e,label:t,readyLabel:n,complete:r,completeLabel:i=`Reopen`,onComplete:a,onReopen:o,disabled:s=!1,disabledTitle:c=``}){return r?(0,k.jsxs)(`button`,{onClick:o,className:`main-action-button progress-action-button`,children:[(0,k.jsx)(ue,{size:18}),` `,i]}):(Number.isFinite(e)?Math.max(0,Math.min(100,e)):0)>=100&&!s?(0,k.jsxs)(`button`,{onClick:a,className:`main-action-button progress-action-button`,children:[(0,k.jsx)(T,{size:18}),` `,n]}):(0,k.jsxs)(`button`,{className:`main-action-button progress-action-button`,disabled:!0,title:c,children:[(0,k.jsx)(T,{size:18}),` `,t]})}function Yt({label:e,value:t,onChange:n,disabled:r=!1,min:i=0}){let a=Math.max(i,Number(t||i));return(0,k.jsxs)(`div`,{children:[(0,k.jsx)(sn,{text:e}),(0,k.jsxs)(`div`,{className:`counter-field mt-1`,children:[(0,k.jsx)(`input`,{className:`field counter-input`,type:`number`,min:i,value:a,onChange:e=>n(Math.max(i,Number(e.target.value||i))),disabled:r}),(0,k.jsxs)(`div`,{className:`counter-stepper`,children:[(0,k.jsx)(`button`,{type:`button`,onClick:()=>n(a+1),disabled:r,children:`+`}),(0,k.jsx)(`button`,{type:`button`,onClick:()=>n(Math.max(i,a-1)),disabled:r,children:`−`})]})]})]})}function Xt({objective:e,parent:t,ownerTitle:n,ancestry:r,setSelection:i,locked:a=!1,canFocusBranch:o=!1,isBranchFocused:s=!1,setBranchFocus:c,clearBranchFocus:l,updateObjective:u,toggleComplete:d,template:f}){let p=(e.children||[]).length>0,m=Re(e);return(0,k.jsxs)(`div`,{className:`space-y-4`,children:[(0,k.jsxs)(`div`,{className:`wiki-meta-block`,children:[(0,k.jsx)($t,{ancestry:r||[],setSelection:i}),(0,k.jsx)(Qt,{objective:e,ancestry:r||[],setSelection:i})]}),!f&&(0,k.jsx)(`div`,{className:`main-action-row`,children:p?(0,k.jsx)(Jt,{progress:Qe(e),label:`Complete objective`,readyLabel:`Complete objective`,complete:m,completeLabel:`Mark incomplete`,onComplete:d,onReopen:d,disabled:!qe(e),disabledTitle:`Complete all child objectives first.`}):(0,k.jsxs)(`button`,{onClick:d,className:`main-action-button`,children:[m?(0,k.jsx)(ue,{size:18}):ze(e)&&!Ve(e)?(0,k.jsx)(E,{size:18}):(0,k.jsx)(T,{size:18}),m?`Mark incomplete`:ze(e)&&!Ve(e)?`Progress objective`:`Complete objective`]})}),p&&(0,k.jsx)(qt,{progress:Qe(e),label:`Objective progress`}),!p&&ze(e)&&(0,k.jsx)(qt,{progress:Ue(e),label:`Count progress`,detail:`${He(e).progress} / ${He(e).target}`}),(0,k.jsx)(cn,{label:`Title`,value:e.title,onChange:e=>u(t=>({...t,title:e})),disabled:a}),(0,k.jsx)(ln,{label:`Description`,value:e.description,onChange:e=>u(t=>({...t,description:e})),disabled:a}),(0,k.jsx)(fn,{label:`Child rule`,value:e.mode,options:be,onChange:e=>u(t=>({...t,mode:e})),disabled:a}),(0,k.jsxs)(`div`,{className:`grid grid-cols-2 gap-3`,children:[(0,k.jsx)(Yt,{label:`Count target`,value:e.countTarget||0,min:0,disabled:a||p,onChange:e=>u(t=>{let n=Math.max(0,Number(e||0)),r=Math.min(n,Math.max(0,Number(t.countProgress||0)));return{...t,countTarget:n,countProgress:r,completed:!1}})}),(0,k.jsx)(Yt,{label:`Count progress`,value:e.countProgress||0,disabled:p||!(e.countTarget>0),onChange:e=>u(t=>{let n=Math.max(0,Number(t.countTarget||0)),r=Math.min(n,Math.max(0,Number(e||0)));return{...t,countProgress:r,completed:!1}},{allowLockedProgress:!0})})]}),(0,k.jsx)(`div`,{className:`rounded-xl border border-neutral-800 bg-neutral-950 p-3 text-sm text-neutral-400`,children:p?`Parent objective: can be completed after its children are complete.`:e.countTarget>0?`Counted leaf objective: progress clicks advance the counter until complete.`:f?`Template leaf: generated copies can be completed later.`:`Leaf objective: can be completed directly.`})]})}function Zt({quest:e,setSelection:t}){let n=e?.objectives||[];return n.length===0?(0,k.jsxs)(`div`,{className:`wiki-meta-line`,children:[(0,k.jsx)(`span`,{className:`wiki-meta-label`,children:`Children:`}),` `,(0,k.jsx)(`span`,{className:`text-neutral-500`,children:`None`})]}):(0,k.jsxs)(`div`,{className:`wiki-meta-line`,children:[(0,k.jsx)(`span`,{className:`wiki-meta-label`,children:`Children:`}),` `,n.map((n,r)=>(0,k.jsxs)(_.Fragment,{children:[r>0&&(0,k.jsx)(`span`,{children:`, `}),(0,k.jsx)(`button`,{className:`wiki-link-button`,onClick:()=>t({type:`objective`,questId:e.id,id:n.id}),children:n.title||`Untitled`})]},n.id))]})}function Qt({objective:e,ancestry:t,setSelection:n}){let r=e?.children||[];if(r.length===0)return null;let i=t?.[0];return(0,k.jsxs)(`div`,{className:`wiki-meta-line`,children:[(0,k.jsx)(`span`,{className:`wiki-meta-label`,children:`Children:`}),` `,r.map((e,t)=>(0,k.jsxs)(_.Fragment,{children:[t>0&&(0,k.jsx)(`span`,{children:`, `}),(0,k.jsx)(`button`,{className:`wiki-link-button`,onClick:()=>{i?.type===`quest`&&n&&n({type:`objective`,questId:i.id,id:e.id}),i?.type===`routine`&&n&&n({type:`routineObjective`,routineId:i.id,id:e.id})},children:e.title||`Untitled`})]},e.id))]})}function $t({ancestry:e,setSelection:t}){return!e||e.length===0?null:(0,k.jsx)(`div`,{className:`ancestry-path`,children:e.map((e,n)=>(0,k.jsxs)(_.Fragment,{children:[n>0&&(0,k.jsx)(`span`,{className:`ancestry-separator`,children:`›`}),(0,k.jsx)(`button`,{className:`ancestry-button`,onClick:()=>{e.type===`quest`&&t({type:`quest`,id:e.id}),e.type===`routine`&&t({type:`routine`,id:e.id}),e.type===`objective`&&t({type:`objective`,questId:e.questId,id:e.id}),e.type===`routineObjective`&&t({type:`routineObjective`,routineId:e.routineId,id:e.id})},children:e.title||`Untitled`})]},`${e.type}-${e.id}-${n}`))})}function en({title:e,kind:t,selected:n,onSelect:r}){return(0,k.jsx)(`div`,{className:[`tree-row`,`tree-root-row`,n?`tree-row-selected`:``,`tree-root-${t}`].join(` `),onClick:r,children:(0,k.jsxs)(`div`,{className:`tree-root-content`,children:[(0,k.jsx)(`div`,{className:`tree-root-icon`,children:`◆`}),(0,k.jsx)(`div`,{className:`tree-root-title`,children:e||`Untitled`}),(0,k.jsx)(`div`,{className:`tree-root-icon`,children:`◆`})]})})}function tn({objectives:e,expanded:t,setExpanded:n,onSelect:r,onAddChild:i,onDelete:a,onMoveUp:o,onMoveDown:s,onToggleComplete:c,depth:l=0,template:u=!1,treeEditMode:d=!1,selection:f=null,treeContext:p=null}){return!e||e.length===0?(0,k.jsx)(`div`,{className:`text-sm text-neutral-500`,children:`No objectives yet.`}):(0,k.jsx)(`div`,{className:`tree-node-list`,children:e.map(e=>{let m=e.children||[],h=m.length>0,g=t[e.id]??!0,_=Re(e),v=Ct(f,p,e),y=[`tree-row`,_?`tree-row-complete`:``,v?`tree-row-selected`:``,d?`tree-row-edit`:``].join(` `);return(0,k.jsxs)(`div`,{className:`tree-node-wrap`,children:[(0,k.jsxs)(`div`,{className:[l>0?`tree-row-wrap tree-node-child`:`tree-row-wrap tree-node-root`,h?`tree-row-branch`:`tree-row-leaf`].join(` `),children:[(0,k.jsx)(`div`,{className:`tree-disclosure-gutter`,children:h?(0,k.jsx)(`button`,{className:`tree-disclosure`,onClick:r=>{r.stopPropagation(),n({...t,[e.id]:!g})},children:g?(0,k.jsx)(ce,{size:16}):(0,k.jsx)(le,{size:16})}):(0,k.jsx)(`div`,{className:`tree-disclosure-spacer`})}),(0,k.jsxs)(`div`,{className:y,onClick:()=>!d&&r(e),children:[(0,k.jsxs)(`div`,{className:`tree-row-main`,children:[(0,k.jsxs)(`div`,{className:`tree-row-title`,children:[e.title||`Untitled objective`,ze(e)&&(0,k.jsxs)(`span`,{className:`tree-count-suffix`,children:[` (`,He(e).progress,`/`,He(e).target,`)`]})]}),h&&(0,k.jsx)(`div`,{className:`tree-row-mode`,children:e.mode===`sequence`?`seq`:`all`})]}),(0,k.jsx)(`div`,{className:`tree-row-buttons`,onClick:e=>e.stopPropagation(),children:d?(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`button`,{onClick:()=>o?.(e),className:`tree-icon-button`,title:`Move up`,children:(0,k.jsx)(se,{size:14})}),(0,k.jsx)(`button`,{onClick:()=>s?.(e),className:`tree-icon-button`,title:`Move down`,children:(0,k.jsx)(ie,{size:14})}),(0,k.jsx)(`button`,{onClick:()=>i(e),className:`tree-icon-button`,title:`Add child`,children:(0,k.jsx)(D,{size:14})}),(0,k.jsx)(`button`,{onClick:()=>a?.(e),className:`tree-icon-button danger-tree-button`,title:`Delete`,children:(0,k.jsx)(fe,{size:14})})]}):!u&&(!h||_||Je(e))&&(0,k.jsx)(`button`,{onClick:()=>c(e),className:`tree-icon-button`,title:_?`Mark incomplete`:h?`Confirm complete`:`Complete`,children:_?(0,k.jsx)(pe,{size:14}):ze(e)&&!Ve(e)?(0,k.jsx)(E,{size:14}):(0,k.jsx)(T,{size:14})})})]})]}),h&&g&&(0,k.jsx)(`div`,{className:`tree-children-group`,children:(0,k.jsx)(tn,{objectives:m,expanded:t,setExpanded:n,onSelect:r,onAddChild:i,onDelete:a,onMoveUp:o,onMoveDown:s,onToggleComplete:c,depth:l+1,template:u,treeEditMode:d,selection:f,treeContext:p})})]},e.id)})})}function nn({label:e,value:t,onChange:n,disabled:r=!1}){function i(e){r||n(t^e)}return(0,k.jsxs)(`div`,{children:[(0,k.jsx)(sn,{text:e}),(0,k.jsx)(`div`,{className:`day-mask-row`,children:ve.map(e=>(0,k.jsx)(`button`,{type:`button`,className:(t&e.bit)===0?`day-button`:`day-button day-button-active`,onClick:()=>i(e.bit),disabled:r,children:e.label},e.key))})]})}function rn({tags:e,allTags:t,onChange:n,disabled:r=!1}){let[i,a]=(0,_.useState)(``);function o(t){n(e.includes(t)?e.filter(e=>e!==t):[...e,t])}function s(){let t=i.trim();t&&(e.includes(t)||n([...e,t]),a(``))}return(0,k.jsxs)(`div`,{children:[(0,k.jsx)(sn,{text:`Tags`}),(0,k.jsx)(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:t.map(t=>(0,k.jsx)(`button`,{onClick:()=>!r&&o(t),disabled:r,className:e.includes(t)?`pill-green`:`pill`,children:t},t))}),(0,k.jsxs)(`div`,{className:`mt-2 flex gap-2`,children:[(0,k.jsx)(`input`,{className:`field`,value:i,onChange:e=>a(e.target.value),placeholder:`Custom tag`,disabled:r}),(0,k.jsx)(`button`,{className:`secondary-button`,onClick:s,disabled:r,children:`Add`})]})]})}function an({tab:e,setTab:t}){return(0,k.jsxs)(`div`,{className:`panel-title-bar library-tab-bar`,children:[(0,k.jsx)(`button`,{onClick:()=>t(`quests`),className:e===`quests`?`library-title-tab library-title-tab-active`:`library-title-tab`,children:`Quests`}),(0,k.jsx)(`button`,{onClick:()=>t(`routines`),className:e===`routines`?`library-title-tab library-title-tab-active`:`library-title-tab`,children:`Routines`}),(0,k.jsx)(`button`,{onClick:()=>t(`save`),className:e===`save`?`library-title-tab library-title-tab-active`:`library-title-tab`,children:`Save/Load`})]})}function on({title:e,children:t,className:n=``}){return(0,k.jsxs)(`div`,{className:`panel-title-bar ${n}`,children:[(0,k.jsx)(`div`,{className:`panel-title-text`,children:e}),t&&(0,k.jsx)(`div`,{className:`panel-title-actions`,children:t})]})}function sn({text:e}){return(0,k.jsx)(`label`,{className:`block text-sm font-medium text-neutral-300`,children:e})}function cn({label:e,value:t,onChange:n,disabled:r=!1}){return(0,k.jsxs)(`div`,{children:[(0,k.jsx)(sn,{text:e}),(0,k.jsx)(`input`,{className:`field mt-1`,value:t||``,onChange:e=>n(e.target.value),disabled:r})]})}function ln({label:e,value:t,onChange:n,disabled:r=!1}){return(0,k.jsxs)(`div`,{children:[(0,k.jsx)(sn,{text:e}),(0,k.jsx)(`textarea`,{className:`field mt-1 min-h-24`,value:t||``,onChange:e=>n(e.target.value),disabled:r})]})}function un({label:e,value:t,onChange:n,disabled:r=!1}){return(0,k.jsxs)(`div`,{children:[(0,k.jsx)(sn,{text:e}),(0,k.jsx)(`input`,{className:`field mt-1`,type:`number`,min:`1`,value:t||1,onChange:e=>n(Number(e.target.value)),disabled:r})]})}function dn({label:e,value:t,onChange:n,disabled:r=!1}){return(0,k.jsxs)(`div`,{children:[(0,k.jsx)(sn,{text:e}),(0,k.jsx)(`input`,{className:`field mt-1`,type:`date`,value:t||``,onChange:e=>n(e.target.value),disabled:r})]})}function fn({label:e,value:t,options:n,onChange:r,disabled:i=!1}){return(0,k.jsxs)(`div`,{children:[(0,k.jsx)(sn,{text:e}),(0,k.jsx)(`select`,{className:`field mt-1`,value:t,onChange:e=>r(e.target.value),disabled:i,children:n.map(e=>(0,k.jsx)(`option`,{children:e},e))})]})}function pn(){return(0,k.jsx)(`style`,{children:`
      html, body, #root {
        height: 100%;
        margin: 0;
        overflow: hidden;
