...
- Commit if the change is good`})]})]}),Be({id:`quest_oil_change`,title:`Change Car Oil`,description:`Recurring maintenance task for changing car oil.
...
- Top off if needed`})]}),Be({id:`quest_laundry`,title:`Laundry`,description:`Recurring household task for laundry.
...
- Put everything away`})]}),Be({id:`quest_update_website`,title:`Update Website`,description:`Reference quest for publishing changes to the GitHub Pages web version.
...
Ctrl + Shift + R`})]}),Be({id:`quest_update_appimage`,title:`Update AppImage`,description:`Reference quest for rebuilding the Linux desktop AppImage after changing the app.
...
- Create/edit works
- Save/Load works
- No white screen`})]})]};function it(e){if(!e||typeof e!=`object`)return rt;let t=Array.isArray(e.quests)?e.quests.map(e=>{let t=ye(e.rootTask?.children||e.tasks||[]);return Be({...e,completedAt:e.completedAt||``,openedAt:e.openedAt||``,cooldownEnabled:e.cooldownEnabled||!1,cooldownAmount:e.cooldownAmount||6,cooldownUnit:e.cooldownUnit||`months`,rootTask:{...e.rootTask||{},mode:e.rootTask?.mode||e.mode||`all`,completed:!!(e.rootTask?.completed||e.status===`completed`),children:t}})}):[];return{activeQuestId:e.activeQuestId||t[0]?.id||null,activeBranchTaskId:e.activeBranchTaskId||null,quests:t}}function at(e){let t=e?.cooldownEnabled?`cooldown`:`none`,n=e?.scheduleType||t;return[`none`,`cooldown`,`routine`,`event`].includes(n)?n:t}function ot(e){let t=e?.schedule&&typeof e.schedule==`object`?e.schedule:{};return{dayMask:t.dayMask??e?.dayMask??0,eventDate:t.eventDate||e?.eventDate||``,cooldownAmount:Math.max(1,Number(t.cooldownAmount??e?.cooldownAmount??6)),cooldownUnit:t.cooldownUnit||e?.cooldownUnit||`months`}}function st(e,t){return!!((ot(e).dayMask||0)&S(t))}function ct(e,t){let n=at(e),r=ot(e);if(n!==`event`&&e?.status===`inactive`)return e;if(n===`cooldown`){if(!M(e)||!e.completedAt)return e;let n=ee(e.completedAt,r.cooldownAmount,r.cooldownUnit);return n<=t?Ve(e,t,{deadline:``}):e.deadline===n?e:{...e,deadline:n}}return n===`routine`?!st(e,t)||e.openedAt===t?e:Ve(e,t,{deadline:t}):n===`event`&&r.eventDate?t<r.eventDate?{...e,status:`inactive`,deadline:r.eventDate}:!e.openedAt||e.status===`inactive`?Ve(e,t,{deadline:r.eventDate}):e.deadline===r.eventDate?e:{...e,deadline:r.eventDate}:e}function lt(e,t=``){let n=t||x(),r=(e.quests||[]).map(e=>ct(e,n));return{...e,quests:r}}function ut(e){return e?e.type===`quest`?`quest:${e.id}`:e.type===`task`?`task:${e.questId}:${e.id}`:`none`:`none`}function dt(e,t,n){return!e||!n||!t?!1:(t.type===`quest`||t.type===`focus`)&&e.type===`task`?e.questId===t.quest?.id&&e.id===n.id:!1}function ft(e,t,n){if(e?.type===`quest`){let n=t.quests.find(t=>t.id===e.id);if(n)return{type:`quest`,quest:n,title:`Quest Tree: ${n.title}`}}if(e?.type===`task`){let n=t.quests.find(t=>t.id===e.questId);if(n)return{type:`quest`,quest:n,title:`Quest Tree: ${n.title}`}}return n?{type:`focus`,quest:n,title:`Focus Tree: ${n.title}`}:{type:`empty`,title:`Tree`}}function pt(e){return e.type===`quest`||e.type===`focus`?`tree-panel quest-type-regular-tree`:`tree-panel`}function mt(e){return e?e.scheduleType===`event`?`quest-type-event`:e.scheduleType===`routine`?`quest-type-routine`:e.scheduleType===`cooldown`||e.cooldownEnabled?`quest-type-cooldown`:`quest-type-regular`:``}function ht(e,t=`quest`){return String(e||t).trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||t}function gt(e,t){let n=new Blob([JSON.stringify(e,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}function _t(e){return new Promise((t,n)=>{if(!e){t(null);return}let r=new FileReader;r.onload=()=>{try{t(JSON.parse(String(r.result||`{}`)))}catch(e){n(e)}},r.onerror=()=>n(r.error||Error(`Could not read file.`)),r.readAsText(e)})}function vt(e){return{app:`quest-planner`,version:1,exportedAt:new Date().toISOString(),data:e}}function yt(e){return{app:`quest-planner`,type:`quest-scene`,version:1,exportedAt:new Date().toISOString(),quest:e}}function bt(e){return e?.data&&typeof e.data==`object`?e.data:e}function xt(e){return e?.quest&&typeof e.quest==`object`?e.quest:e}var St=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),Ct=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),wt=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),Tt=e=>{let t=wt(e);return t.charAt(0).toUpperCase()+t.slice(1)},Et={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},Dt=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},Ot=(0,_.createContext)({}),kt=()=>(0,_.useContext)(Ot),At=(0,_.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=kt()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,_.createElement)(`svg`,{ref:c,...Et,width:t??l??Et.width,height:t??l??Et.height,stroke:e??f,strokeWidth:m,className:St(`lucide`,p,i),...!a&&!Dt(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,_.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),jt=(e,t)=>{let n=(0,_.forwardRef)(({className:n,...r},i)=>(0,_.createElement)(At,{ref:i,iconNode:t,className:St(`lucide-${Ct(Tt(e))}`,`lucide-${e}`,n),...r}));return n.displayName=Tt(e),n},Mt=jt(`arrow-down`,[[`path`,{d:`M12 5v14`,key:`s699le`}],[`path`,{d:`m19 12-7 7-7-7`,key:`1idqje`}]]),Nt=jt(`arrow-left`,[[`path`,{d:`m12 19-7-7 7-7`,key:`1l729n`}],[`path`,{d:`M19 12H5`,key:`x3x0zl`}]]),Pt=jt(`arrow-right`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`m12 5 7 7-7 7`,key:`xquz4c`}]]),Ft=jt(`arrow-up`,[[`path`,{d:`m5 12 7-7 7 7`,key:`hav0vg`}],[`path`,{d:`M12 19V5`,key:`x0mq9r`}]]),It=jt(`chevron-down`,[[`path`,{d:`m6 9 6 6 6-6`,key:`qrunsl`}]]),Lt=jt(`chevron-right`,[[`path`,{d:`m9 18 6-6-6-6`,key:`mthhwq`}]]),Rt=jt(`circle-check`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),zt=jt(`play`,[[`path`,{d:`M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z`,key:`10ikf1`}]]),Bt=jt(`plus`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`M12 5v14`,key:`s699le`}]]),Vt=jt(`rotate-ccw`,[[`path`,{d:`M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8`,key:`1357e3`}],[`path`,{d:`M3 3v5h5`,key:`1xhq8a`}]]),Ht=jt(`search`,[[`path`,{d:`m21 21-4.34-4.34`,key:`14j7rj`}],[`circle`,{cx:`11`,cy:`11`,r:`8`,key:`4ej97u`}]]),Ut=jt(`trash-2`,[[`path`,{d:`M10 11v6`,key:`nco0om`}],[`path`,{d:`M14 11v6`,key:`outv1u`}],[`path`,{d:`M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6`,key:`miytrc`}],[`path`,{d:`M3 6h18`,key:`d0wm0j`}],[`path`,{d:`M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2`,key:`e791ji`}]]),Wt=jt(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]),Gt=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),N=o(((e,t)=>{t.exports=Gt()}))();function Kt({search:e,setSearch:t,tagFilter:n,setTagFilter:r,allTags:i,hideCompleted:a,setHideCompleted:o,showDisabled:s,setShowDisabled:c,quests:l,activeQuestId:u,dueBadge:d,createQuest:f,selectQuest:p}){return(0,N.jsxs)(`div`,{className:`tab-scene-margin library-scene quest-board-root`,children:[(0,N.jsxs)(`div`,{className:`quest-board-toolbar`,children:[(0,N.jsxs)(`div`,{className:`space-y-2`,children:[(0,N.jsxs)(`div`,{className:`relative`,children:[(0,N.jsx)(Ht,{className:`absolute left-3 top-2.5 text-neutral-500`,size:16}),(0,N.jsx)(`input`,{className:`field py-2 pl-9`,value:e,onChange:e=>t(e.target.value),placeholder:``})]}),(0,N.jsxs)(`select`,{className:`field py-2`,value:n,onChange:e=>r(e.target.value),children:[(0,N.jsx)(`option`,{children:`All`}),i.map(e=>(0,N.jsx)(`option`,{children:e},e))]}),(0,N.jsxs)(`label`,{className:`flex items-center gap-2 rounded-xl border border-neutral-700 bg-neutral-950 px-3 py-2 text-sm text-neutral-300`,children:[(0,N.jsx)(`input`,{type:`checkbox`,checked:a,onChange:e=>o(e.target.checked)}),`Hide complete`]}),(0,N.jsxs)(`label`,{className:`flex items-center gap-2 rounded-xl border border-neutral-700 bg-neutral-950 px-3 py-2 text-sm text-neutral-300`,children:[(0,N.jsx)(`input`,{type:`checkbox`,checked:s,onChange:e=>c(e.target.checked)}),`Show disabled`]})]}),(0,N.jsxs)(`button`,{onClick:f,className:`primary-button w-full`,children:[(0,N.jsx)(Bt,{size:18}),` New quest`]})]}),(0,N.jsx)(`div`,{className:`scene-contents-panel quest-board-contents-panel`,children:(0,N.jsx)(`div`,{className:`scene-contents-margin quest-board-contents-margin`,children:(0,N.jsx)(`div`,{className:`quest-board-list`,children:l.map(e=>(0,N.jsxs)(`button`,{onClick:()=>p(e),className:`library-card text-left ${mt(e)} ${M(e)||We(e)?`library-card-complete`:``} ${e.id===u?`border-neutral-300 bg-neutral-800`:``}`,children:[(0,N.jsxs)(`div`,{className:`flex items-start justify-between gap-3`,children:[(0,N.jsx)(`div`,{className:`font-semibold`,children:e.title}),d(e)]}),(0,N.jsx)(`div`,{className:`mt-2 h-2 overflow-hidden rounded-full bg-neutral-800`,children:(0,N.jsx)(`div`,{className:`h-full bg-slate-200`,style:{width:`${Ke(e)}%`}})}),(0,N.jsxs)(`div`,{className:`mt-3 flex flex-wrap gap-2`,children:[M(e)&&(0,N.jsx)(`span`,{className:`pill-complete`,children:`Completed`}),We(e)&&(0,N.jsx)(`span`,{className:`pill`,children:`Disabled`}),(e.tags||[]).map(e=>(0,N.jsx)(`span`,{className:`pill`,children:e},e))]})]},e.id))})})})]})}function qt({exportJson:e,importJsonFile:t,exportQuestFile:n,importQuestFile:r,hasActiveQuest:i,resetToDefaults:a}){return(0,N.jsx)(`div`,{className:`export-options-root`,children:(0,N.jsx)(`div`,{className:`export-options-scroll`,children:(0,N.jsxs)(`div`,{className:`export-options-content space-y-3`,children:[(0,N.jsx)(`button`,{type:`button`,onClick:e,className:`primary-button w-full justify-center`,children:`Export all data`}),(0,N.jsxs)(`label`,{className:`primary-button w-full cursor-pointer justify-center`,children:[`Load all data`,(0,N.jsx)(`input`,{type:`file`,accept:`application/json,.json`,className:`hidden`,onChange:e=>{t(e.target.files?.[0]),e.target.value=``}})]}),(0,N.jsxs)(`div`,{className:`rounded border border-neutral-800 bg-neutral-950 p-3`,children:[(0,N.jsx)(`div`,{className:`mb-2 text-sm font-semibold text-neutral-200`,children:`Quest files`}),(0,N.jsxs)(`div`,{className:`space-y-2`,children:[(0,N.jsx)(`button`,{type:`button`,onClick:()=>n(),disabled:!i,className:`primary-button w-full justify-center disabled:cursor-not-allowed disabled:opacity-40`,children:`Export active quest`}),(0,N.jsxs)(`label`,{className:`primary-button w-full cursor-pointer justify-center`,children:[`Load quest file`,(0,N.jsx)(`input`,{type:`file`,accept:`application/json,.json,.quest.json`,className:`hidden`,onChange:e=>{r(e.target.files?.[0]),e.target.value=``}})]})]})]}),(0,N.jsx)(`button`,{type:`button`,onClick:a,className:`danger-button w-full justify-center`,children:`Reset to defaults`}),(0,N.jsx)(`div`,{className:`rounded border border-neutral-800 bg-neutral-950 p-3 text-sm text-neutral-400`,children:`Export all data creates a backup of quests. Quest files export/import one quest scene at a time. Load all data replaces the current app state with the selected JSON file.`})]})})})}function Jt({debugDateOverrideEnabled:e,setDebugDateOverrideEnabled:t,debugDateOverrideDate:n,setDebugDateOverrideDate:r,currentAppDate:i,runMaintenanceNow:a}){return(0,N.jsx)(`div`,{className:`export-options-root`,children:(0,N.jsx)(`div`,{className:`export-options-scroll`,children:(0,N.jsxs)(`div`,{className:`export-options-content space-y-3`,children:[(0,N.jsxs)(`div`,{className:`rounded border border-neutral-800 bg-neutral-950 p-3`,children:[(0,N.jsx)(`div`,{className:`mb-2 text-sm font-semibold text-neutral-200`,children:`Date override`}),(0,N.jsxs)(`label`,{className:`mb-3 flex items-center gap-2 text-sm text-neutral-300`,children:[(0,N.jsx)(`input`,{type:`checkbox`,checked:e,onChange:e=>t(e.target.checked)}),`Use debug date`]}),(0,N.jsx)(`input`,{className:`field`,type:`date`,value:n||``,onChange:e=>r(e.target.value)}),(0,N.jsxs)(`div`,{className:`mt-2 text-xs text-neutral-400`,children:[`Current app date: `,i||`real date`]})]}),(0,N.jsx)(`button`,{type:`button`,onClick:a,className:`primary-button w-full justify-center`,children:`Force maintenance`}),(0,N.jsx)(`div`,{className:`rounded border border-neutral-800 bg-neutral-950 p-3 text-sm text-neutral-400`,children:`Changing the date override or its enabled state runs maintenance automatically. Use this tab to test routine rollover, event activation, cooldown expiration, and overdue badges.`})]})})})}function Yt(e){return e?.kind===`questCompletion`||e?.kind===`rootTask`}function Xt({quest:e,focusBoard:t,focusPathInfo:n,setBranchFocus:r,clearBranchFocus:i,selectQuest:a,selectTask:o,toggleTask:s,uncompleteTask:c,expandedKanbanCards:l,setExpandedKanbanCards:u}){return e?(0,N.jsx)(`main`,{className:`focus-tab-root`,children:(0,N.jsx)(`div`,{className:`scene-contents-panel focus-contents-panel`,children:(0,N.jsx)(`div`,{className:`scene-contents-margin focus-contents-margin`,children:(0,N.jsxs)(`div`,{className:`focus-panel-content focus-scene-content`,children:[(0,N.jsx)(tn,{quest:e,focusPathInfo:n,selectQuest:a,selectTask:o,setBranchFocus:r,clearBranchFocus:i}),t.available.some(e=>Yt(e))||M(e)?(0,N.jsx)(`div`,{className:`complete-quest-celebration`,children:(0,N.jsxs)(`button`,{onClick:()=>{let e=t.available.find(e=>Yt(e));e&&s(e)},className:M(e)?`recommended-complete-quest-button recommended-complete-quest-button-done`:`recommended-complete-quest-button`,disabled:M(e),children:[(0,N.jsx)(`span`,{className:`complete-quest-icon`,children:`◆`}),(0,N.jsx)(`span`,{className:`complete-quest-label`,children:M(e)?`Quest completed`:`Complete quest`}),(0,N.jsx)(`span`,{className:`complete-quest-icon`,children:`◆`})]})}):(0,N.jsxs)(`section`,{className:`mt-5 focus-recommend-panel`,children:[(0,N.jsx)(`h3`,{className:`text-lg font-bold`,children:`Recommended`}),t.recommended?(0,N.jsxs)(`div`,{className:`recommended-task-row`,children:[(0,N.jsxs)(`div`,{className:`recommended-task-text`,children:[(0,N.jsx)(nn,{row:t.recommended,selectTask:o}),t.recommended.task.description&&(0,N.jsx)(`div`,{className:`mt-1 text-sm text-neutral-400`,children:t.recommended.task.description})]}),(0,N.jsxs)(`button`,{onClick:()=>s(t.recommended),className:`primary-button recommended-action-button`,children:[A(t.recommended.task)===`progress`?(0,N.jsx)(zt,{size:16}):(0,N.jsx)(Rt,{size:16}),A(t.recommended.task)===`progress`?`Progress`:`Complete`]})]}):(0,N.jsx)(`div`,{className:`mt-2 text-sm text-neutral-500`,children:`No available task. This quest may be complete.`})]}),(0,N.jsxs)(`div`,{className:`branch-progress-line`,children:[(0,N.jsxs)(`div`,{className:`branch-progress-label`,children:[(0,N.jsx)(`span`,{children:`Progress`}),(0,N.jsxs)(`span`,{children:[Number.isFinite(n.progress)?n.progress:0,`%`]})]}),(0,N.jsx)(`div`,{className:`branch-progress-track`,children:(0,N.jsx)(`div`,{className:`branch-progress-fill`,style:{width:`${Number.isFinite(n.progress)?n.progress:0}%`}})})]}),(0,N.jsxs)(`section`,{className:`mt-5 focus-board`,children:[(0,N.jsx)(rn,{title:`Available`,rows:t.available,emptyText:`No available tasks.`,selectTask:o,toggleTask:s,expandedKanbanCards:l,setExpandedKanbanCards:u,showCompleteButton:!0}),(0,N.jsx)(rn,{title:`In Progress`,rows:t.inProgress,emptyText:`No parent tasks in progress.`,selectTask:o,expandedKanbanCards:l,setExpandedKanbanCards:u,showProgress:!0}),(0,N.jsx)(rn,{title:`Completed`,rows:t.completed,emptyText:`Nothing completed yet.`,selectTask:o,uncompleteTask:c,expandedKanbanCards:l,setExpandedKanbanCards:u,completed:!0,showUncompleteButton:!0,summary:`${t.completedCount} / ${t.totalCount}`})]})]})})})}):(0,N.jsx)(`main`,{className:`focus-tab-root`,children:(0,N.jsx)(`div`,{className:`scene-contents-panel focus-contents-panel`,children:(0,N.jsx)(`div`,{className:`scene-contents-margin focus-contents-margin`,children:(0,N.jsx)(`div`,{className:`focus-scene-content focus-empty-message text-neutral-400`,children:`Create or select a quest, then make it the current focus.`})})})})}function Zt(e,t){return e?t?.branchTask||e:null}function Qt(e,t){return e?[{id:e.id,title:e.title||`Untitled quest`,type:`quest`},...(t?.path||[]).map(e=>({id:e.id,title:e.title||`Untitled`,type:`task`}))]:[]}function $t({quest:e,focusPathInfo:t,selectQuest:n,setBranchFocus:r,clearBranchFocus:i}){let a=Qt(e,t);return(0,N.jsxs)(`div`,{className:`focus-directory-path`,children:[(0,N.jsx)(`span`,{className:`focus-relation-label`,children:`Path:`}),a.map((e,t)=>(0,N.jsxs)(_.Fragment,{children:[t>0&&(0,N.jsx)(`span`,{className:`focus-directory-separator`,children:`›`}),(0,N.jsx)(`button`,{className:`focus-directory-link`,onClick:()=>{e.type===`quest`?i():r(e.id)},children:e.title})]},`${e.type}-${e.id}`))]})}function en({quest:e,focusPathInfo:t,setBranchFocus:n,clearBranchFocus:r,selectQuest:i}){let a=t?.childBranches||[];return(0,N.jsx)(`div`,{className:`focus-relations`,children:(0,N.jsxs)(`div`,{className:`focus-relation-line`,children:[(0,N.jsx)(`span`,{className:`focus-relation-label`,children:`Subquests:`}),a.length===0&&(0,N.jsx)(`span`,{className:`focus-relation-muted`,children:`No subquests`}),a.map(e=>(0,N.jsx)(`button`,{type:`button`,className:`focus-relation-chip`,onClick:()=>n(e.id),children:e.title||`Untitled`},e.id))]})})}function tn({quest:e,focusPathInfo:t,selectQuest:n,selectTask:r,setBranchFocus:i,clearBranchFocus:a}){let o=Zt(e,t),s=o?.description||``;return(0,N.jsxs)(`div`,{className:`focus-document-header`,children:[(0,N.jsx)(`button`,{className:`focus-document-title focus-document-title-button`,onClick:()=>{t?.branchTask?r(t.branchTask):n(e)},title:`Select in inspector`,children:o?.title||`Untitled`}),(t?.path||[]).length>0&&(0,N.jsx)($t,{quest:e,focusPathInfo:t,selectQuest:n,setBranchFocus:i,clearBranchFocus:a}),(0,N.jsx)(en,{quest:e,focusPathInfo:t,setBranchFocus:i,clearBranchFocus:a,selectQuest:n}),s.trim()!==``&&(0,N.jsxs)(`div`,{className:`focus-description-section`,children:[(0,N.jsx)(`h3`,{className:`focus-description-title`,children:`Description`}),(0,N.jsx)(`p`,{className:`focus-description-text`,children:s})]})]})}function nn({row:e,selectTask:t}){return(0,N.jsx)(`div`,{className:`focus-path-links`,children:e.path.map((n,r)=>(0,N.jsxs)(_.Fragment,{children:[r>0&&(0,N.jsx)(`span`,{className:`focus-path-separator`,children:`›`}),(0,N.jsx)(`button`,{className:`focus-path-link`,onClick:r=>{r.stopPropagation(),Yt(e)||t(n)},title:`Select in inspector`,children:r===e.path.length-1&&e.displayTitle?e.displayTitle:n.title||`Untitled`})]},n.id))})}function rn({title:e,rows:t,emptyText:n,selectTask:r,toggleTask:i,uncompleteTask:a,expandedKanbanCards:o={},setExpandedKanbanCards:s,showCompleteButton:c=!1,showUncompleteButton:l=!1,showProgress:u=!1,completed:d=!1,summary:f=null}){return(0,N.jsxs)(`div`,{className:`focus-column`,children:[(0,N.jsxs)(`div`,{className:`focus-column-title`,children:[(0,N.jsx)(`span`,{children:e}),(0,N.jsx)(`span`,{className:`focus-column-count`,children:f||t.length})]}),(0,N.jsxs)(`div`,{className:`focus-column-list`,children:[t.length===0&&(0,N.jsx)(`div`,{className:`focus-empty`,children:n}),t.map(e=>{let t=!!(e.task.description||``).trim(),n=!!o[e.task.id];return(0,N.jsxs)(`div`,{className:d?`focus-card focus-card-complete`:`focus-card`,children:[(0,N.jsxs)(`div`,{className:`focus-card-bar`,onClick:()=>!Yt(e)&&r(e.task),role:`button`,tabIndex:0,onKeyDown:t=>{(t.key===`Enter`||t.key===` `)&&(t.preventDefault(),Yt(e)||r(e.task))},children:[(0,N.jsxs)(`div`,{className:`focus-card-main`,children:[(0,N.jsxs)(`div`,{className:`focus-card-title-line`,children:[t&&(0,N.jsx)(`button`,{onClick:t=>{t.stopPropagation(),s?.(t=>({...t,[e.task.id]:!t[e.task.id]}))},className:`focus-card-done focus-card-dropdown`,title:n?`Hide description`:`Show description`,children:n?(0,N.jsx)(It,{size:14}):(0,N.jsx)(Lt,{size:14})}),(0,N.jsx)(nn,{row:e,selectTask:r})]}),u&&e.progress&&(0,N.jsx)(`div`,{className:`focus-card-progress-bar`,title:`${e.progress.complete} / ${e.progress.total}`,children:(0,N.jsx)(`div`,{className:`focus-card-progress-fill`,style:{width:`${e.progress.total>0?Math.round(e.progress.complete/e.progress.total*100):0}%`}})})]}),(0,N.jsxs)(`div`,{className:`focus-card-actions`,children:[c&&(0,N.jsx)(`button`,{onClick:t=>{t.stopPropagation(),i(e)},className:`focus-card-done ${A(e.task)===`progress`?`focus-card-action-progress`:`focus-card-action-complete`}`,title:se(e.task),children:A(e.task)===`progress`?(0,N.jsx)(zt,{size:14}):(0,N.jsx)(Rt,{size:14})}),l&&(0,N.jsx)(`button`,{onClick:t=>{t.stopPropagation(),a(e)},className:`focus-card-done focus-card-action-uncomplete`,title:`Mark incomplete`,children:(0,N.jsx)(Wt,{size:14})})]})]}),D(e.task)&&!e.task.completed&&(0,N.jsx)(`div`,{className:`focus-card-progress-bar focus-card-progress-full`,title:`${O(e.task).progress} / ${O(e.task).target}`,children:(0,N.jsx)(`div`,{className:`focus-card-progress-fill`,style:{width:`${oe(e.task)}%`}})}),t&&n&&(0,N.jsx)(`div`,{className:`focus-card-body`,children:e.task.description})]},e.task.id)})]})]})}var an=180;function on({treeContext:e,rightSplit:t,selection:n,expanded:r,setExpanded:i,setSelection:a,createQuestTask:o,deleteQuestTask:s,moveQuestTask:c,moveQuestTaskToLocation:l,toggleTask:u,embedded:d=!1}){let[f,p]=(0,_.useState)(`normal`),m=f===`rearrange`,[h,g]=(0,_.useState)(null),[v,y]=(0,_.useState)(null),[b,x]=(0,_.useState)(n),S=(0,_.useRef)(null),C=(0,_.useRef)(null),w=(0,_.useRef)(null),ee=(0,_.useRef)(null),te=(0,_.useRef)(null),ne=m?`tree-view-rearrange`:`tree-view-normal`,T=d?`tree-view-root ${pt(e)} ${ne}`:`panel panel-scroll ${pt(e)} ${ne}`,re=d?void 0:{flexBasis:`${100-t}%`};(0,_.useEffect)(()=>{x(n)},[n]),(0,_.useEffect)(()=>{C.current=v},[v]),(0,_.useEffect)(()=>{te.current=h},[h]),(0,_.useEffect)(()=>{function e(e){let t=C.current;if(!t||t.pointerId!==e.pointerId)return;let n=un(e,S.current);te.current=n,g(n)}function t(e){let t=C.current,n=w.current,r=t?.pointerId??n?.pointerId;r==null||r!==e.pointerId||ae(e)}function n(e){let t=C.current,n=w.current,r=t?.pointerId??n?.pointerId;r==null||r!==e.pointerId||se()}return window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`pointercancel`,n),()=>{window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`pointercancel`,n)}},[]);function E(e,t,n=null){if(!m||!t||!C.current)return;let r=un(e,S.current)||ln(e,S.current,t,n);r&&(te.current=r,g(r))}function D(){C.current||(te.current=null,g(null))}function ie(e,t){if(!t?.taskId||e.button!==0)return;e.preventDefault(),e.stopPropagation(),ce();let n={...t,pointerId:e.pointerId,startedAtClientX:e.clientX,startedAtClientY:e.clientY,moveContext:O()};t.selectTree?.(),e.currentTarget.setPointerCapture?.(e.pointerId),w.current=n,ee.current=window.setTimeout(()=>{let t=w.current;!t||t.pointerId!==e.pointerId||(w.current=t,C.current=t,p(`rearrange`),y(t),console.log(`[Tree rearrange] drag start`,t))},an)}function ae(e){let t=w.current,n=C.current;if(e.preventDefault(),e.stopPropagation(),ce(),n){A(e,n);return}t&&(t.select?.(),w.current=null)}function O(){if((e.type===`quest`||e.type===`focus`)&&e.quest){let t=e.quest.rootTask||null;return{kind:e.type,ownerId:e.quest.id,rootId:t?.id||`quest-root-${e.quest.id}`,tasks:t?.children||[],locked:!!e.quest.locked}}return null}function oe(e,t){let n=e?.moveContext||O(),r=t?.placement||t?.zone||null;if(!n)return{ok:!1,reason:`missing-tree-context`,source:e||null,target:t||null};if(n.locked)return{ok:!1,reason:`locked-tree-context`,source:e||null,target:t||null,context:n.kind};if(!e?.taskId)return{ok:!1,reason:`missing-source-task`,source:e||null,target:t||null,context:n.kind};if(!t?.id)return{ok:!1,reason:`missing-drop-target`,source:e,target:t||null,context:n.kind};if(!r)return{ok:!1,reason:`missing-drop-placement`,source:e,target:t,context:n.kind};let i=De(n.tasks,e.taskId,t.id,r,{rootId:n.rootId});return i.moved?{ok:!0,reason:`move-accepted-dry-run`,source:e,target:t,placement:r,context:n.kind,ownerId:n.ownerId,result:i}:{ok:!1,reason:i.reason||`move-rejected`,source:e,target:t,placement:r,context:n.kind,ownerId:n.ownerId}}function k(e){if(!e?.ok)return;let t=e.source?.taskId,n=e.target?.id,r=e.placement;!t||!n||!r||(e.context===`quest`||e.context===`focus`)&&l?.(e.ownerId,t,n,r)}function A(e,t=C.current){if(!t)return;let n=un(e,S.current)||te.current,r={source:t,target:n},i=oe(t,n);i.ok?(console.log(`[Tree rearrange] accepted drag operation`,i),k(i)):console.warn(`[Tree rearrange] rejected drag operation`,i),console.log(`[Tree rearrange] drag release`,r),t.select?.(),w.current=null,C.current=null,y(null),p(`normal`),te.current=null,g(null)}function se(){let e=w.current,t=C.current;ce(),w.current=null,t?console.log(`[Tree rearrange] drag cancel`,t):e&&console.log(`[Tree rearrange] press cancel`,e),C.current=null,y(null),p(`normal`),te.current=null,g(null)}function ce(){ee.current&&=(window.clearTimeout(ee.current),null)}return(0,N.jsxs)(`section`,{className:`${T} ${v?`tree-drag-active`:``}`,style:re,children:[(0,N.jsx)(`div`,{className:`tree-scene-header`,children:(0,N.jsxs)(`div`,{className:`tree-toolbar`,children:[(0,N.jsxs)(`div`,{className:`tree-toolbar-context`,children:[(0,N.jsx)(`span`,{className:`tree-mode-pill`,children:e.type===`focus`?`Focus`:e.type===`quest`?`Quest`:`Empty`}),v&&(0,N.jsxs)(`span`,{className:`tree-drag-pill`,children:[`Dragging: `,v.title]})]}),(0,N.jsx)(`div`,{className:`tree-toolbar-actions`,children:(0,N.jsx)(`button`,{className:`title-secondary-button`,onClick:()=>{if((e.type===`quest`||e.type===`focus`)&&e.quest&&!e.quest.locked){let t=n.type===`task`?n.id:null;o(e.quest.id,t)}},children:`+ Task`})})]})}),(0,N.jsx)(`div`,{className:`scene-contents-panel tree-contents-panel`,children:(0,N.jsx)(`div`,{className:`scene-contents-margin tree-contents-margin`,children:(0,N.jsxs)(`div`,{className:`tree-scene-content`,ref:S,onMouseLeave:D,children:[h&&(0,N.jsx)(pn,{indicator:h}),(e.type===`quest`||e.type===`focus`)&&e.quest&&(0,N.jsx)(sn,{id:e.quest.rootTask?.id||`quest-root-${e.quest.id}`,title:e.quest.title,kind:`root-${e.type,mt(e.quest)}`,selected:b.type===`quest`&&b.id===e.quest.id,expanded:r,setExpanded:i,onSelect:()=>a({type:`quest`,id:e.quest.id}),dropIndicator:h,updateDropIndicator:E,children:(0,N.jsx)(hn,{tasks:e.quest.rootTask?.children||[],expanded:r,setExpanded:i,onSelect:t=>a({type:`task`,questId:e.quest.id,id:t.id}),onAddChild:t=>o(e.quest.id,t.id),onDelete:t=>s(e.quest.id,t.id),onMoveUp:t=>c(e.quest.id,t.id,-1),onMoveDown:t=>c(e.quest.id,t.id,1),onToggleComplete:t=>u(e.quest.id,t.id),depth:1,treeEditMode:!1,selection:b,setTreeSelection:x,treeContext:e,dropIndicator:h,updateDropIndicator:E,beginTreeDrag:ie,rearrangeMode:m})}),e.type===`empty`&&(0,N.jsx)(`div`,{className:`text-sm text-neutral-500`,children:`No quest selected.`})]})})})]})}function sn({id:e,title:t,kind:n,selected:r,expanded:i,setExpanded:a,onSelect:o,dropIndicator:s,updateDropIndicator:c,children:l}){let u=i[e]??!0,d=[`tree-row`,`tree-root-row`,r?`tree-row-selected`:``,`tree-root-${n}`].join(` `);return(0,N.jsxs)(`div`,{className:`tree-node-wrap tree-root-node-wrap`,children:[(0,N.jsxs)(`div`,{className:`tree-row-wrap tree-node-root tree-row-branch`,children:[(0,N.jsx)(`div`,{className:`tree-disclosure-gutter`,children:(0,N.jsx)(`button`,{className:`tree-disclosure`,onClick:t=>{t.stopPropagation(),a({...i,[e]:!u})},title:u?`Collapse root`:`Expand root`,children:u?(0,N.jsx)(It,{size:16}):(0,N.jsx)(Lt,{size:16})})}),(0,N.jsx)(`div`,{className:d,"data-tree-row-id":e,"data-tree-has-children":`true`,"data-tree-open":u?`true`:`false`,onMouseMove:t=>c?.(t,e),onClick:o,children:(0,N.jsxs)(`div`,{className:`tree-root-content`,children:[(0,N.jsx)(`div`,{className:`tree-root-icon`,children:`◆`}),(0,N.jsx)(`div`,{className:`tree-root-title`,children:t||`Untitled`}),(0,N.jsx)(`div`,{className:`tree-root-icon`,children:`◆`})]})})]}),u&&(0,N.jsx)(`div`,{className:`tree-children-group`,children:l})]})}function cn(e,t){let n=t.getBoundingClientRect(),r=e.clientY-n.top,i=n.height>0?r/n.height:.5;return i<.25?`before`:i>.75?`after`:`inside`}function ln(e,t,n,r=null){let i=e.currentTarget;return dn(e,t,i,n,r)}function un(e,t){if(!t)return null;let n=document.elementFromPoint(e.clientX,e.clientY);if(!n||!t.contains(n))return null;let r=n.closest?.(`.tree-subtree-end-drop-zone`);if(r&&t.contains(r)){let n=r.dataset.treeSubtreeEndFor;return dn(e,t,r,n,`subtree-after`)}let i=n.closest?.(`[data-tree-row-id]`);return!i||!t.contains(i)?null:dn(e,t,i,i.dataset.treeRowId)}function dn(e,t,n,r,i=null){if(!t||!n||!r)return null;let a=t.getBoundingClientRect(),o=Array.from(t.querySelectorAll(`[data-tree-row-id]`)),s=fn(o,r)||n,c=s.getBoundingClientRect();if(i===`subtree-after`){let e=n.getBoundingClientRect();return{id:r,zone:`after`,type:`boundary`,top:e.top+e.height/2-a.top,left:c.left-a.left,width:c.width,placement:`subtree-after`}}let l=i||cn(e,n);if(l===`inside`)return{id:r,zone:l,type:`inside`,top:c.top-a.top,left:c.left-a.left,width:c.width,height:c.height};let u=o.indexOf(s),d=u>0?o[u-1]:null,f=u>=0&&u<o.length-1?o[u+1]:null,p=s.dataset.treeHasChildren===`true`&&s.dataset.treeOpen===`true`,m=l===`before`?c.top:c.bottom,h=s,g=l;if(l===`before`&&d&&(m=(d.getBoundingClientRect().bottom+c.top)/2),l===`after`&&p&&f){let e=f.getBoundingClientRect();m=(c.bottom+e.top)/2,h=f,g=`first-child`}else if(l===`after`&&f){let e=f.getBoundingClientRect();m=(c.bottom+e.top)/2}let _=h.getBoundingClientRect();return{id:r,zone:l,type:`boundary`,top:m-a.top,left:_.left-a.left,width:_.width,placement:g}}function fn(e,t){return e.find(e=>e.dataset.treeRowId===t)||null}function pn({indicator:e}){if(!e)return null;let t={top:`${e.top}px`,left:`${e.left}px`,width:`${e.width}px`};return e.type===`inside`&&(t.height=`${e.height}px`),(0,N.jsx)(`div`,{className:e.type===`inside`?`tree-drop-overlay tree-drop-overlay-inside`:`tree-drop-overlay tree-drop-overlay-boundary`,style:t})}function mn(e){return E(e)?`tree-status-complete`:D(e)&&O(e).progress>0||(e.children||[]).some(e=>mn(e)!==`tree-status-empty`)?`tree-status-in-progress`:`tree-status-empty`}function hn({tasks:e,expanded:t,setExpanded:n,onSelect:r,onAddChild:i,onDelete:a,onMoveUp:o,onMoveDown:s,onToggleComplete:c,depth:l=0,parentId:u=null,template:d=!1,treeEditMode:f=!1,selection:p=null,setTreeSelection:m=null,treeContext:h=null,dropIndicator:g=null,updateDropIndicator:_=null,beginTreeDrag:v=null,rearrangeMode:y=!1}){return!e||e.length===0?(0,N.jsx)(`div`,{className:`text-sm text-neutral-500`,children:`No tasks yet.`}):(0,N.jsx)(`div`,{className:`tree-node-list`,children:e.map((e,y)=>{let b=e.children||[],x=b.length>0,S=t[e.id]??!0,C=E(e),w=mn(e),ee=dt(p,h,e),te=[`tree-row`,w,C?`tree-row-complete`:``,ee?`tree-row-selected`:``].join(` `);return(0,N.jsxs)(`div`,{className:`tree-node-wrap`,children:[(0,N.jsxs)(`div`,{className:[l>0?`tree-row-wrap tree-node-child`:`tree-row-wrap tree-node-root`,x?`tree-row-branch`:`tree-row-leaf`].join(` `),children:[(0,N.jsx)(`div`,{className:`tree-disclosure-gutter`,children:x?(0,N.jsx)(`button`,{className:`tree-disclosure`,onClick:r=>{r.stopPropagation(),n({...t,[e.id]:!S})},children:S?(0,N.jsx)(It,{size:16}):(0,N.jsx)(Lt,{size:16})}):(0,N.jsx)(`div`,{className:`tree-disclosure-spacer`})}),(0,N.jsxs)(`div`,{className:te,"data-tree-row-id":e.id,"data-tree-has-children":x?`true`:`false`,"data-tree-open":S?`true`:`false`,"data-tree-parent-id":u||``,"data-tree-index":y,onPointerDown:t=>v?.(t,{taskId:e.id,parentId:u,index:y,title:e.title||`Untitled task`,contextType:h?.type||`unknown`,selectTree:()=>{m&&h?.quest?.id&&m({type:`task`,questId:h.quest.id,id:e.id})},select:()=>r(e)}),onMouseMove:t=>_?.(t,e.id),onClick:e=>{e.preventDefault()},children:[(0,N.jsxs)(`div`,{className:`tree-row-main`,children:[(0,N.jsxs)(`div`,{className:`tree-row-title`,children:[e.title||`Untitled task`,D(e)&&(0,N.jsxs)(`span`,{className:`tree-count-suffix`,children:[` (`,O(e).progress,`/`,O(e).target,`)`]})]}),x&&(0,N.jsx)(`div`,{className:`tree-row-mode`,children:e.mode===`sequence`?`seq`:`all`})]}),(0,N.jsx)(`div`,{className:`tree-row-buttons`,onPointerDown:e=>e.stopPropagation(),onClick:e=>e.stopPropagation(),children:f?(0,N.jsxs)(N.Fragment,{children:[(0,N.jsx)(`button`,{onClick:()=>o?.(e),className:`tree-icon-button`,title:`Move up`,children:(0,N.jsx)(Ft,{size:14})}),(0,N.jsx)(`button`,{onClick:()=>s?.(e),className:`tree-icon-button`,title:`Move down`,children:(0,N.jsx)(Mt,{size:14})}),(0,N.jsx)(`button`,{onClick:()=>i(e),className:`tree-icon-button`,title:`Add child`,children:(0,N.jsx)(Bt,{size:14})}),(0,N.jsx)(`button`,{onClick:()=>a?.(e),className:`tree-icon-button danger-tree-button`,title:`Delete`,children:(0,N.jsx)(Ut,{size:14})})]}):!d&&(!x||C||le(e))&&(0,N.jsx)(`button`,{onClick:()=>c(e),className:`tree-icon-button`,title:C?`Mark incomplete`:x?`Confirm complete`:`Complete`,children:C?(0,N.jsx)(Wt,{size:14}):D(e)&&!ae(e)?(0,N.jsx)(zt,{size:14}):(0,N.jsx)(Rt,{size:14})})})]})]}),x&&S&&(0,N.jsxs)(N.Fragment,{children:[(0,N.jsx)(`div`,{className:`tree-children-group`,children:(0,N.jsx)(hn,{tasks:b,expanded:t,setExpanded:n,onSelect:r,onAddChild:i,onDelete:a,onMoveUp:o,onMoveDown:s,onToggleComplete:c,depth:l+1,parentId:e.id,template:d,treeEditMode:f,selection:p,setTreeSelection:m,treeContext:h,dropIndicator:g,updateDropIndicator:_,beginTreeDrag:v})}),(0,N.jsx)(`div`,{className:`tree-subtree-end-drop-zone`,"data-tree-subtree-end-for":e.id,onMouseMove:t=>_?.(t,e.id,`subtree-after`)})]})]},e.id)})})}function gn({progress:e,label:t=`Progress`,detail:n=``}){let r=Number.isFinite(e)?Math.max(0,Math.min(100,e)):0;return(0,N.jsxs)(`div`,{className:`inspector-progress-block`,children:[(0,N.jsxs)(`div`,{className:`inspector-progress-header`,children:[(0,N.jsx)(`span`,{children:t}),(0,N.jsx)(`span`,{children:n||`${r}%`})]}),(0,N.jsx)(`div`,{className:`inspector-progress-bar`,children:(0,N.jsx)(`div`,{className:`inspector-progress-fill`,style:{width:`${r}%`}})})]})}function _n({progress:e,label:t,readyLabel:n,complete:r,completeLabel:i=`Reopen`,onComplete:a,onReopen:o,disabled:s=!1,disabledTitle:c=``}){return r?(0,N.jsxs)(`button`,{onClick:o,className:`main-action-button progress-action-button`,children:[(0,N.jsx)(Vt,{size:18}),` `,i]}):(Number.isFinite(e)?Math.max(0,Math.min(100,e)):0)>=100&&!s?(0,N.jsxs)(`button`,{onClick:a,className:`main-action-button progress-action-button`,children:[(0,N.jsx)(Rt,{size:18}),` `,n]}):(0,N.jsxs)(`button`,{className:`main-action-button progress-action-button`,disabled:!0,title:c,children:[(0,N.jsx)(Rt,{size:18}),` `,t]})}function vn({label:e,value:t,onChange:n,disabled:r=!1,min:i=0}){let a=Math.max(i,Number(t||i));return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(P,{text:e}),(0,N.jsxs)(`div`,{className:`counter-field mt-1`,children:[(0,N.jsx)(`input`,{className:`field counter-input`,type:`number`,min:i,value:a,onChange:e=>n(Math.max(i,Number(e.target.value||i))),disabled:r}),(0,N.jsxs)(`div`,{className:`counter-stepper`,children:[(0,N.jsx)(`button`,{type:`button`,onClick:()=>n(a+1),disabled:r,children:`+`}),(0,N.jsx)(`button`,{type:`button`,onClick:()=>n(Math.max(i,a-1)),disabled:r,children:`−`})]})]})]})}function yn({quest:e,setSelection:t}){let n=e?.rootTask?.children||[];return n.length===0?(0,N.jsxs)(`div`,{className:`wiki-meta-line`,children:[(0,N.jsx)(`span`,{className:`wiki-meta-label`,children:`Children:`}),` `,(0,N.jsx)(`span`,{className:`text-neutral-500`,children:`None`})]}):(0,N.jsxs)(`div`,{className:`wiki-meta-line`,children:[(0,N.jsx)(`span`,{className:`wiki-meta-label`,children:`Children:`}),` `,n.map((n,r)=>(0,N.jsxs)(_.Fragment,{children:[r>0&&(0,N.jsx)(`span`,{children:`, `}),(0,N.jsx)(`button`,{className:`wiki-link-button`,onClick:()=>t({type:`task`,questId:e.id,id:n.id}),children:n.title||`Untitled`})]},n.id))]})}function bn({task:e,ancestry:t,setSelection:n}){let r=e?.children||[];if(r.length===0)return null;let i=t?.[0];return(0,N.jsxs)(`div`,{className:`wiki-meta-line`,children:[(0,N.jsx)(`span`,{className:`wiki-meta-label`,children:`Children:`}),` `,r.map((e,t)=>(0,N.jsxs)(_.Fragment,{children:[t>0&&(0,N.jsx)(`span`,{children:`, `}),(0,N.jsx)(`button`,{className:`wiki-link-button`,onClick:()=>{i?.type===`quest`&&n&&n({type:`task`,questId:i.id,id:e.id})},children:e.title||`Untitled`})]},e.id))]})}function xn({ancestry:e,setSelection:t}){return!e||e.length===0?null:(0,N.jsx)(`div`,{className:`ancestry-path`,children:e.map((e,n)=>(0,N.jsxs)(_.Fragment,{children:[n>0&&(0,N.jsx)(`span`,{className:`ancestry-separator`,children:`›`}),(0,N.jsx)(`button`,{className:`ancestry-button`,onClick:()=>{e.type===`quest`&&t({type:`quest`,id:e.id}),e.type===`task`&&t({type:`task`,questId:e.questId,id:e.id})},children:e.title||`Untitled`})]},`${e.type}-${e.id}-${n}`))})}function Sn({label:e,value:t,onChange:n,disabled:r=!1}){function i(e){r||n(t^e)}return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(P,{text:e}),(0,N.jsx)(`div`,{className:`day-mask-row`,children:y.map(e=>(0,N.jsx)(`button`,{type:`button`,className:(t&e.bit)===0?`day-button`:`day-button day-button-active`,onClick:()=>i(e.bit),disabled:r,children:e.label},e.key))})]})}function Cn({tags:e,allTags:t,onChange:n,disabled:r=!1}){let[i,a]=(0,_.useState)(``);function o(t){n(e.includes(t)?e.filter(e=>e!==t):[...e,t])}function s(){let t=i.trim();t&&(e.includes(t)||n([...e,t]),a(``))}return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(P,{text:`Tags`}),(0,N.jsx)(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:t.map(t=>(0,N.jsx)(`button`,{onClick:()=>!r&&o(t),disabled:r,className:e.includes(t)?`pill-green`:`pill`,children:t},t))}),(0,N.jsxs)(`div`,{className:`mt-2 flex gap-2`,children:[(0,N.jsx)(`input`,{className:`field`,value:i,onChange:e=>a(e.target.value),placeholder:`Custom tag`,disabled:r}),(0,N.jsx)(`button`,{className:`secondary-button`,onClick:s,disabled:r,children:`Add`})]})]})}function P({text:e}){return(0,N.jsx)(`label`,{className:`block text-sm font-medium text-neutral-300`,children:e})}function wn({label:e,value:t,onChange:n,disabled:r=!1}){return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(P,{text:e}),(0,N.jsx)(`input`,{className:`field mt-1`,value:t||``,onChange:e=>n(e.target.value),disabled:r})]})}function Tn({label:e,value:t,onChange:n,disabled:r=!1}){return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(P,{text:e}),(0,N.jsx)(`textarea`,{className:`field mt-1 min-h-24`,value:t||``,onChange:e=>n(e.target.value),disabled:r})]})}function En({label:e,value:t,onChange:n,disabled:r=!1}){return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(P,{text:e}),(0,N.jsx)(`input`,{className:`field mt-1`,type:`number`,min:`1`,value:t||1,onChange:e=>n(Number(e.target.value)),disabled:r})]})}function Dn({label:e,value:t,onChange:n,disabled:r=!1}){return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(P,{text:e}),(0,N.jsx)(`input`,{className:`field mt-1`,type:`date`,value:t||``,onChange:e=>n(e.target.value),disabled:r})]})}function On({label:e,value:t,options:n,onChange:r,disabled:i=!1}){return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(P,{text:e}),(0,N.jsx)(`select`,{className:`field mt-1`,value:t,onChange:e=>r(e.target.value),disabled:i,children:n.map(e=>(0,N.jsx)(`option`,{children:e},e))})]})}function kn({quest:e,allTags:t,setData:n,completeQuest:r,restoreQuest:i,deleteQuest:a}){function o(t){n(n=>({...n,quests:n.quests.map(n=>n.id===e.id?{...n,...t}:n)}))}function s(e){o({status:e?`active`:`inactive`,updatedAt:new Date().toISOString(),enabledChangedAt:x()})}let c=M(e),l=!!e.completedAt,u=An(e)===`event`,d=e.status!==`inactive`;return(0,N.jsxs)(`div`,{className:`space-y-4`,children:[(0,N.jsx)(`div`,{className:`main-action-row`,children:(0,N.jsx)(_n,{progress:Ke(e),label:`Complete quest`,readyLabel:`Complete quest`,complete:c&&l,completeLabel:`Reopen quest`,onComplete:r,onReopen:i,disabled:!Ge(e),disabledTitle:`Complete all root tasks first.`})}),(0,N.jsx)(gn,{progress:Ke(e),label:`Quest progress`}),(0,N.jsxs)(`label`,{className:`flex items-center gap-2 rounded-xl border border-neutral-800 bg-neutral-950 px-3 py-2 text-sm text-neutral-300`,children:[(0,N.jsx)(`input`,{type:`checkbox`,checked:d,disabled:u,onChange:e=>s(e.target.checked)}),`Enabled`,u&&(0,N.jsx)(`span`,{className:`text-xs text-neutral-500`,children:`Event quests enable automatically on their event date.`})]}),(0,N.jsx)(wn,{label:`Title`,value:e.title,onChange:e=>o({title:e})}),(0,N.jsx)(Tn,{label:`Description`,value:e.description,onChange:e=>o({description:e})}),(0,N.jsx)(Cn,{tags:e.tags||[],allTags:t,onChange:e=>o({tags:e})}),(0,N.jsxs)(`div`,{className:`grid grid-cols-2 gap-3`,children:[(0,N.jsx)(On,{label:`Difficulty`,value:e.difficulty,options:et,onChange:e=>o({difficulty:e})}),(0,N.jsx)(On,{label:`Rule`,value:e.rootTask?.mode||`all`,options:tt,onChange:t=>o({rootTask:{...e.rootTask,mode:t}})})]}),(0,N.jsx)(Pn,{quest:e,updateQuest:o}),(0,N.jsx)(`div`,{className:`danger-zone`,children:(0,N.jsxs)(`button`,{onClick:a,className:`danger-button w-full`,title:`Delete quest`,children:[(0,N.jsx)(Ut,{size:16}),` Delete quest`]})})]})}function An(e){return Ne.includes(e?.scheduleType)?e.scheduleType:e?.cooldownEnabled?`cooldown`:`none`}function jn(e){return Fe({cooldownAmount:e?.cooldownAmount??e?.schedule?.cooldownAmount??6,cooldownUnit:e?.cooldownUnit||e?.schedule?.cooldownUnit||`months`,dayMask:e?.schedule?.dayMask??e?.dayMask??0,eventDate:e?.schedule?.eventDate||e?.eventDate||``,...e?.schedule||{}})}function Mn(e,t,n={}){let r=Fe({...jn(e),...n});return{scheduleType:t,schedule:r,cooldownEnabled:t===`cooldown`,cooldownAmount:r.cooldownAmount,cooldownUnit:r.cooldownUnit}}function Nn({value:e,onChange:t,disabled:n=!1}){return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`label`,{className:`block text-sm font-medium text-neutral-300`,children:`Regime`}),(0,N.jsx)(`select`,{className:`field mt-1`,value:e,onChange:e=>t(e.target.value),children:Ne.map(e=>(0,N.jsx)(`option`,{value:e,children:Pe[e]||e},e))})]})}function Pn({quest:e,updateQuest:t}){let[n,r]=(0,_.useState)(!1),i=An(e),a=jn(e);function o(n){t(Mn(e,n))}function s(n){t(Mn(e,i,n))}let c=Re({...e,scheduleType:i,schedule:a});return(0,N.jsxs)(`section`,{className:`rounded-xl border border-neutral-800 bg-neutral-950/70`,children:[(0,N.jsxs)(`button`,{type:`button`,className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left`,onClick:()=>r(e=>!e),children:[(0,N.jsxs)(`span`,{className:`inline-flex items-center gap-2 font-semibold text-neutral-200`,children:[n?(0,N.jsx)(It,{size:16}):(0,N.jsx)(Lt,{size:16}),`Schedule`]}),(0,N.jsx)(`span`,{className:`truncate text-xs text-neutral-400`,children:c})]}),n&&(0,N.jsxs)(`div`,{className:`grid gap-3 border-t border-neutral-800 p-3`,children:[(0,N.jsx)(Nn,{value:i,onChange:o}),i===`none`&&(0,N.jsx)(Dn,{label:`Due date`,value:e.deadline,onChange:e=>t({deadline:e})}),i===`cooldown`&&(0,N.jsxs)(N.Fragment,{children:[(0,N.jsxs)(`div`,{className:`grid grid-cols-2 gap-3`,children:[(0,N.jsx)(En,{label:`Cooldown amount`,value:a.cooldownAmount,onChange:e=>s({cooldownAmount:e})}),(0,N.jsx)(On,{label:`Cooldown unit`,value:a.cooldownUnit,options:nt,onChange:e=>s({cooldownUnit:e})})]}),e.completedAt&&(0,N.jsxs)(`div`,{className:`text-xs text-neutral-400`,children:[`Completed `,e.completedAt,`. It will reopen after `,a.cooldownAmount,` `,a.cooldownUnit,`.`]})]}),i===`routine`&&(0,N.jsx)(Sn,{label:`Active days`,value:a.dayMask,onChange:e=>s({dayMask:e})}),i===`event`&&(0,N.jsx)(Dn,{label:`Event date`,value:a.eventDate,onChange:e=>s({eventDate:e})})]})]})}function Fn({task:e,parent:t,ownerTitle:n,ancestry:r,setSelection:i,locked:a=!1,canFocusBranch:o=!1,isBranchFocused:s=!1,setBranchFocus:c,clearBranchFocus:l,updateTask:u,toggleComplete:d,deleteTask:f,template:p}){let m=(e.children||[]).length>0,h=E(e);return(0,N.jsxs)(`div`,{className:`space-y-4`,children:[!p&&(0,N.jsx)(`div`,{className:`main-action-row`,children:m?(0,N.jsx)(_n,{progress:j(e),label:`Complete task`,readyLabel:`Complete task`,complete:h,completeLabel:`Mark incomplete`,onComplete:d,onReopen:d,disabled:!ce(e),disabledTitle:`Complete all child tasks first.`}):(0,N.jsxs)(`button`,{onClick:d,className:`main-action-button`,children:[h?(0,N.jsx)(Vt,{size:18}):D(e)&&!ae(e)?(0,N.jsx)(zt,{size:18}):(0,N.jsx)(Rt,{size:18}),h?`Mark incomplete`:D(e)&&!ae(e)?`Progress task`:`Complete task`]})}),m&&(0,N.jsx)(gn,{progress:j(e),label:`Task progress`}),!m&&D(e)&&(0,N.jsx)(gn,{progress:oe(e),label:`Count progress`,detail:`${O(e).progress} / ${O(e).target}`}),(0,N.jsx)(wn,{label:`Title`,value:e.title,onChange:e=>u(t=>({...t,title:e})),disabled:a}),(0,N.jsx)(Tn,{label:`Description`,value:e.description,onChange:e=>u(t=>({...t,description:e})),disabled:a}),(0,N.jsx)(On,{label:`Child rule`,value:e.mode,options:tt,onChange:e=>u(t=>({...t,mode:e})),disabled:a}),(0,N.jsxs)(`div`,{className:`grid grid-cols-2 gap-3`,children:[(0,N.jsx)(vn,{label:`Count target`,value:e.countTarget||0,min:0,disabled:a||m,onChange:e=>u(t=>{let n=Math.max(0,Number(e||0)),r=Math.min(n,Math.max(0,Number(t.countProgress||0)));return{...t,countTarget:n,countProgress:r,completed:!1}})}),(0,N.jsx)(vn,{label:`Count progress`,value:e.countProgress||0,disabled:m||!(e.countTarget>0),onChange:e=>u(t=>{let n=Math.max(0,Number(t.countTarget||0)),r=Math.min(n,Math.max(0,Number(e||0)));return{...t,countProgress:r,completed:!1}},{allowLockedProgress:!0})})]}),(0,N.jsx)(`div`,{className:`rounded-xl border border-neutral-800 bg-neutral-950 p-3 text-sm text-neutral-400`,children:m?`Parent task: can be completed after its children are complete.`:e.countTarget>0?`Counted leaf task: progress clicks advance the counter until complete.`:p?`Template leaf: generated copies can be completed later.`:`Leaf task: can be completed directly.`}),(0,N.jsx)(`div`,{className:`danger-zone`,children:(0,N.jsxs)(`button`,{onClick:f,disabled:a||!f,className:`danger-button w-full disabled:opacity-40 disabled:cursor-not-allowed`,title:a?`Locked tasks cannot be deleted.`:`Delete task`,children:[(0,N.jsx)(Ut,{size:16}),` Delete task`]})})]})}function In(e){let{rightSplit:t,embedded:n=!1}=e;return(0,N.jsx)(`div`,{className:n?`inspector-root inspector-root-embedded`:`inspector-root`,style:n?void 0:{flexBasis:`${t}%`},children:(0,N.jsx)(`div`,{className:`inspector-main-margin`,children:(0,N.jsxs)(`div`,{className:`inspector-main-vbox`,children:[(0,N.jsx)(Bn,{...e}),(0,N.jsx)(Vn,{...e}),(0,N.jsx)(`div`,{className:`scene-contents-panel inspector-contents-panel`,children:(0,N.jsx)(`div`,{className:`scene-contents-margin inspector-contents-margin`,children:(0,N.jsx)(`div`,{className:`inspector-scene-content`,children:(0,N.jsx)(Hn,{...e})})})})]})})})}function Ln(e){let t=e?.type||`none`;return t===`quest`?`Quest`:t===`task`?`Task`:`Nothing`}function Rn(e){let t=e?.type||`none`;return t===`quest`?`inspector-title-quest`:t===`task`?`inspector-title-task`:``}function zn(e,t,n,r){if(!e||!t)return null;if(e.type===`quest`){let i=t.quests.find(t=>t.id===e.id);if(!i)return null;let a=n===i.id&&!r;return{label:`Focus`,disabled:a,title:a?`Already focused here`:`Focus this quest`,actionType:`quest`,questId:i.id}}if(e.type===`task`){let i=t.quests.find(t=>t.id===e.questId);if(!i)return null;let a=xe(i.rootTask?.children||[],e.id)||[];if(!a[a.length-1])return null;let o=[...a].reverse().find(e=>(e.children||[]).length>0);if(o){let e=n===i.id&&r===o.id;return{label:`Focus`,disabled:e,title:e?`Already focused here`:`Focus nearest branch`,actionType:`task`,questId:i.id,taskId:o.id}}let s=n===i.id&&!r;return{label:`Focus`,disabled:s,title:s?`Already focused here`:`Focus owner quest`,actionType:`quest`,questId:i.id}}return null}function Bn({selection:e,data:t,activeQuestId:n,activeBranchTaskId:r,makeFocus:i,setBranchFocus:a,goBack:o,goForward:s,canGoBack:c,canGoForward:l}){let u=zn(e,t,n,r);function d(){!u||u.disabled||(u.actionType===`quest`&&i(u.questId),u.actionType===`task`&&(i(u.questId),a(u.taskId)))}return(0,N.jsxs)(`div`,{className:`inspector-toolbar`,children:[(0,N.jsx)(`div`,{className:`inspector-toolbar-section`,children:(0,N.jsx)(`span`,{className:`inspector-selection-badge ${Rn(e)}`,children:Ln(e)})}),(0,N.jsxs)(`div`,{className:`inspector-toolbar-actions`,children:[u&&(0,N.jsx)(`button`,{onClick:d,disabled:u.disabled,className:`title-secondary-button`,title:u.title,children:`Focus`}),(0,N.jsx)(`button`,{onClick:o,disabled:!c,className:`title-icon-button disabled:opacity-30`,children:(0,N.jsx)(Nt,{size:16})}),(0,N.jsx)(`button`,{onClick:s,disabled:!l,className:`title-icon-button disabled:opacity-30`,children:(0,N.jsx)(Pt,{size:16})})]})]})}function Vn({selection:e,data:t,setSelection:n}){let r=Un(e,t);if(!r||!e||e.type===`none`)return null;if(e.type===`quest`&&r?.quest)return(0,N.jsx)(`div`,{className:`inspector-relations-strip`,children:(0,N.jsx)(`div`,{className:`wiki-meta-block`,children:(0,N.jsx)(yn,{quest:r.quest,setSelection:n})})});if(e.type===`task`&&r?.task){let i=Se(e,t)||[];return(0,N.jsx)(`div`,{className:`inspector-relations-strip`,children:(0,N.jsxs)(`div`,{className:`wiki-meta-block`,children:[(0,N.jsx)(xn,{ancestry:i,setSelection:n}),(0,N.jsx)(bn,{task:r.task,ancestry:i,setSelection:n})]})})}return null}function Hn({selection:e,data:t,setData:n,setSelection:r,allTags:i,activeQuestId:a,makeFocus:o,activeBranchTaskId:s,setBranchFocus:c,clearBranchFocus:l,completeQuest:u,restoreQuest:d,deleteQuest:f,deleteQuestTask:p,toggleTask:m}){let h=Un(e,t);return(0,N.jsxs)(`div`,{className:`inspector-mode-content`,children:[e.type===`quest`&&h?.quest&&(0,N.jsx)(kn,{quest:h.quest,allTags:i,setData:n,setSelection:r,completeQuest:()=>u(h.quest.id),restoreQuest:()=>d(h.quest.id),deleteQuest:()=>f(h.quest.id)}),e.type===`task`&&h?.quest&&h?.task&&(0,N.jsx)(Fn,{task:h.task,parent:h.parent,ownerTitle:h.quest.title,ancestry:Se(e,t),setSelection:r,locked:h.quest.locked||h.task.locked,canFocusBranch:h.quest.id===a&&(h.task.children||[]).length>0,isBranchFocused:s===h.task.id,setBranchFocus:()=>c(h.task.id),clearBranchFocus:l,updateTask:t=>{n(n=>({...n,quests:n.quests.map(n=>n.id===h.quest.id?{...n,rootTask:{...n.rootTask,children:Ce(n.rootTask?.children||[],e.id,t)}}:n)}))},toggleComplete:()=>m(h.quest.id,h.task.id),deleteTask:()=>p(h.quest.id,h.task.id),template:!1}),(!h||e.type===`none`)&&(0,N.jsx)(`div`,{className:`rounded-2xl border border-neutral-800 bg-neutral-950 p-4 text-neutral-400`,children:`Select an item from the library or focus tree.`})]})}function Un(e,t){if(!e||e.type===`none`)return null;if(e.type===`quest`)return{quest:t.quests.find(t=>t.id===e.id)};if(e.type===`task`){let n=t.quests.find(t=>t.id===e.questId),r=n?be(n.rootTask?[n.rootTask]:[],e.id):null;return{quest:n,task:r?.task,parent:r?.parent}}return null}function Wn({tabs:e=[],activeTabId:t,onActiveTabChange:n,className:r=``,contentClassName:i=`tab-scene-root`,empty:a=null}){let o=e.filter(Boolean);if(o.length===0)return a;let s=o.find(e=>e.id===t)||o[0];return(0,N.jsxs)(`div`,{className:[`tab-container`,r].filter(Boolean).join(` `),children:[(0,N.jsx)(`div`,{className:`tab-container-bar`,children:o.map(e=>(0,N.jsx)(`button`,{type:`button`,onClick:()=>n?.(e.id),className:e.id===s.id?`tab-container-tab tab-container-tab-active`:`tab-container-tab`,title:e.title,children:e.title},e.id))}),(0,N.jsx)(`div`,{className:[`tab-container-content`,i].filter(Boolean).join(` `),children:s.content})]})}function Gn({dockId:e,tabs:t=[],activePanelId:n,onActivePanelChange:r,className:i=``,panelClassName:a=`panel panel-scroll`,style:o=void 0,contentClassName:s=`tab-scene-root`,empty:c=null}){let l=t.filter(Boolean);return l.length===0?c:(0,N.jsx)(`section`,{className:[a,i].filter(Boolean).join(` `),"data-dock-id":e,style:o,children:(0,N.jsx)(Wn,{tabs:l,activeTabId:n,onActiveTabChange:r,contentClassName:s})})}var Kn=Object.freeze({TOP_LEFT:`topLeft`,BOTTOM_LEFT:`bottomLeft`,CENTER:`center`,TOP_RIGHT:`topRight`,BOTTOM_RIGHT:`bottomRight`}),F=Object.freeze({QUEST_BOARD:`questBoard`,EXPORT_PANEL:`exportPanel`,FOCUS_PANEL:`focusPanel`,INSPECTOR_PANEL:`inspectorPanel`,DEBUG_PANEL:`debugPanel`,TREE_VIEW_PANEL:`treeViewPanel`});Object.freeze({[F.QUEST_BOARD]:Object.freeze({id:F.QUEST_BOARD,title:`Quest Board`,defaultDock:Kn.TOP_LEFT}),[F.EXPORT_PANEL]:Object.freeze({id:F.EXPORT_PANEL,title:`Export`,defaultDock:Kn.TOP_LEFT}),[F.FOCUS_PANEL]:Object.freeze({id:F.FOCUS_PANEL,title:`Focus`,defaultDock:Kn.CENTER}),[F.INSPECTOR_PANEL]:Object.freeze({id:F.INSPECTOR_PANEL,title:`Inspector`,defaultDock:Kn.TOP_RIGHT}),[F.DEBUG_PANEL]:Object.freeze({id:F.DEBUG_PANEL,title:`Debug`,defaultDock:Kn.TOP_RIGHT}),[F.TREE_VIEW_PANEL]:Object.freeze({id:F.TREE_VIEW_PANEL,title:`Tree View`,defaultDock:Kn.BOTTOM_RIGHT})}),Object.freeze({[Kn.TOP_LEFT]:Object.freeze([F.QUEST_BOARD,F.EXPORT_PANEL]),[Kn.BOTTOM_LEFT]:Object.freeze([]),[Kn.CENTER]:Object.freeze([F.FOCUS_PANEL]),[Kn.TOP_RIGHT]:Object.freeze([F.INSPECTOR_PANEL,F.DEBUG_PANEL]),[Kn.BOTTOM_RIGHT]:Object.freeze([F.TREE_VIEW_PANEL])});var qn=`0.575rem`;function Jn(e){return e?.kind===`questCompletion`||e?.kind===`rootTask`}function Yn(){let[e,t]=(0,_.useState)(()=>{let e=localStorage.getItem(Ze),t=rt;if(e)try{t=it(JSON.parse(e))}catch{t=rt}let n=lt(t);return localStorage.setItem(Qe,x()),n}),[n,r]=(0,_.useState)(F.QUEST_BOARD),[i,a]=(0,_.useState)(F.FOCUS_PANEL||`focusPanel`),[o,s]=(0,_.useState)(F.INSPECTOR_PANEL),[c,l]=(0,_.useState)(F.TREE_VIEW_PANEL),[u,d]=(0,_.useState)({type:`quest`,id:e.activeQuestId||e.quests[0]?.id||null}),[f,p]=(0,_.useState)([{type:`quest`,id:e.activeQuestId||e.quests[0]?.id||null}]),[m,h]=(0,_.useState)(0),[g,v]=(0,_.useState)(``),[y,b]=(0,_.useState)(`All`),[S,C]=(0,_.useState)(!1),[w,ee]=(0,_.useState)(!1),[te,re]=(0,_.useState)({}),[ie,ae]=(0,_.useState)(62),[oe,k]=(0,_.useState)(360),[A,se]=(0,_.useState)(430),[de,j]=(0,_.useState)({}),[pe,me]=(0,_.useState)(!1),[he,ge]=(0,_.useState)(x());function ve(){return pe&&he?he:x()}function ye(e=ve()){t(t=>lt(t,e)),localStorage.setItem(Qe,e)}let be=e.quests||[],xe=be.find(t=>t.id===e.activeQuestId)||be[0]||null,Se=Ye(xe,e.activeBranchTaskId);fe(Se.root?.tasks||[],Se.root?.mode||`all`);let Oe=qe(_e(Se.root),xe);function ke(e){d(e),p(t=>{let n=t.slice(0,m+1),r=n[n.length-1];if(ut(r)===ut(e))return t;let i=[...n,e];return h(i.length-1),i})}function Ae(){if(m<=0)return;let e=m-1;h(e),d(f[e])}function je(){if(m>=f.length-1)return;let e=m+1;h(e),d(f[e])}(0,_.useEffect)(()=>{localStorage.setItem(Ze,JSON.stringify(e))},[e]),(0,_.useEffect)(()=>{let e=setInterval(()=>{let e=ve();localStorage.getItem(`quest_planner_last_tick_v4`)!==e&&(t(t=>lt(t,e)),localStorage.setItem(Qe,e))},6e4);return()=>clearInterval(e)},[pe,he]),(0,_.useEffect)(()=>{ye()},[pe,he]);let Me=(0,_.useMemo)(()=>{let e=new Set($e);return be.forEach(t=>(t.tags||[]).forEach(t=>e.add(t))),Array.from(e).sort()},[be]),Ne=(0,_.useMemo)(()=>be.filter(e=>`${e.title} ${e.description} ${(e.tags||[]).join(` `)}`.toLowerCase().includes(g.toLowerCase())&&(y===`All`||(e.tags||[]).includes(y))&&(!S||!M(e))&&(w||e.status!==`inactive`)).sort((e,t)=>{let n=Number(M(e))-Number(M(t));return n===0?(e.deadline||`9999-99-99`).localeCompare(t.deadline||`9999-99-99`)||e.title.localeCompare(t.title):n}),[be,g,y,S,w]);function Pe(){let e=Be({title:`New Quest`});t(t=>({...t,quests:[e,...t.quests]})),ke({type:`quest`,id:e.id})}function Fe(e,n=null){let r=T({title:`New Task`});t(t=>({...t,quests:t.quests.map(t=>t.id===e?{...t,status:`active`,completedAt:``,rootTask:{...t.rootTask,completed:!1,children:we(t.rootTask?.children||[],n,r)}}:t)}));let i=be.find(t=>t.id===e)?.rootTask?.id||null,a=n||i;a&&re(e=>({...e,[a]:!0})),ke({type:`task`,questId:e,id:r.id})}function Ie(e){t(t=>{let n=t.quests.filter(t=>t.id!==e);return{...t,quests:n,activeQuestId:t.activeQuestId===e?n[0]?.id||null:t.activeQuestId,activeBranchTaskId:t.activeQuestId===e?null:t.activeBranchTaskId}}),ke({type:`none`})}function Le(e,n){t(t=>({...t,quests:t.quests.map(t=>t.id===e?{...t,status:`active`,completedAt:``,rootTask:{...t.rootTask,completed:!1,children:Te(t.rootTask?.children||[],n)}}:t)})),ke({type:`quest`,id:e})}function Re(e,n,r){t(t=>({...t,quests:t.quests.map(t=>t.id===e?{...t,rootTask:{...t.rootTask,children:Ee(t.rootTask?.children||[],n,r)}}:t)}))}function ze(e,n,r,i){!e||!n||!r||(t(t=>({...t,quests:t.quests.map(t=>{if(t.id!==e||t.locked)return t;let a=t.rootTask||{},o=De(a.children||[],n,r,i,{rootId:a.id});return o.moved?{...t,status:`active`,completedAt:``,rootTask:{...a,completed:!1,children:o.tasks}}:(console.warn(`[Tree rearrange] quest move rejected during mutation`,{questId:e,sourceTaskId:n,targetTaskId:r,placement:i,reason:o.reason}),t)})})),(i===`inside`||i===`first-child`)&&re(e=>({...e,[r]:!0})),ke({type:`task`,questId:e,id:n}))}function Ve(e,n){t(t=>({...t,quests:t.quests.map(t=>{if(t.id!==e)return t;let r=t.rootTask;if(!r)return t;if(r.id===n){if(!E(r)&&!le(r))return t;let e=!E(r);return{...t,status:e?`completed`:`active`,completedAt:e?ve():``,rootTask:{...r,completed:e,countProgress:0}}}let i=null,a=Ce(r.children||[],n,e=>{if((e.children||[]).length>0&&!ce(e))return e;if(D(e)&&!e.completed){let{target:t,progress:n}=O(e);return n<t?(i=null,{...e,countProgress:Math.min(t,n+1),completed:!1}):(i=!0,{...e,completed:!0,countProgress:t})}return i=!e.completed,{...e,completed:i,countProgress:i?O(e).progress:0}});return i===!1&&(a=ue(a,n)),{...t,status:`active`,completedAt:``,rootTask:{...r,completed:!1,children:a}}})}))}function He(e,n){t(t=>({...t,quests:t.quests.map(t=>{if(t.id!==e)return t;let r=t.rootTask;if(!r)return t;if(r.id===n)return{...t,status:`active`,completedAt:``,rootTask:ne(r)};let i=ue(Ce(r.children||[],n,e=>ne(e)),n);return{...t,status:`active`,completedAt:``,rootTask:{...r,completed:!1,children:i}}})}))}function Ue(e){t(t=>({...t,activeQuestId:e,activeBranchTaskId:null}))}function We(e){t(t=>({...t,activeBranchTaskId:e}))}function Ke(){t(e=>({...e,activeBranchTaskId:null}))}function Je(e){t(t=>({...t,quests:t.quests.map(t=>t.id!==e||!Ge(t)?t:{...t,status:`completed`,completedAt:ve(),rootTask:{...t.rootTask,completed:!0}})}))}function Xe(e){t(t=>({...t,quests:t.quests.map(t=>t.id===e?{...t,status:`active`,completedAt:``,rootTask:ne(t.rootTask)}:t)}))}function et(){let t=x();gt(vt(e),`quest-planner-${t}.json`)}function tt(e=xe){if(!e)return;let t=x(),n=`${ht(e.title)}-${t}.quest.json`;gt(yt(e),n)}async function nt(e){if(e)try{let n=it({quests:[xt(await _t(e))]}).quests[0];if(!n)throw Error(`No quest found in file.`);t(e=>{let t=(e.quests||[]).some(e=>e.id===n.id)?e.quests.map(e=>e.id===n.id?n:e):[n,...e.quests||[]],r={...e,quests:t,activeQuestId:n.id,activeBranchTaskId:null};return localStorage.setItem(Ze,JSON.stringify(r)),localStorage.setItem(Qe,x()),r}),ke({type:`quest`,id:n.id}),p([{type:`quest`,id:n.id}]),h(0),re({}),j({})}catch{window.alert(`Could not load that quest file. It may not be a valid quest scene export.`)}}async function at(e){if(e)try{let n=lt(it(bt(await _t(e))));t(n),ke({type:`quest`,id:n.activeQuestId||n.quests[0]?.id||null}),p([{type:`quest`,id:n.activeQuestId||n.quests[0]?.id||null}]),h(0),re({}),j({}),localStorage.setItem(Ze,JSON.stringify(n)),localStorage.setItem(Qe,x())}catch{window.alert(`Could not load that JSON file. It may not be a valid quest planner export.`)}}function ot(){if(!window.confirm(`Reset all quests to the default state? This clears the saved app data in this browser.`))return;let e=lt(it(rt));localStorage.removeItem(Ze),localStorage.removeItem(Qe),localStorage.setItem(Ze,JSON.stringify(e)),localStorage.setItem(Qe,x()),t(e),ke({type:`quest`,id:e.activeQuestId||e.quests[0]?.id||null}),p([{type:`quest`,id:e.activeQuestId||e.quests[0]?.id||null}]),h(0),re({}),j({})}function st(){ye()}function ct(e){let t=ve();return e?.deadline?e.deadline<t?(0,N.jsx)(`span`,{className:`badge bg-red-950 text-red-200`,children:`Overdue`}):e.deadline===t?(0,N.jsx)(`span`,{className:`badge bg-amber-950 text-amber-200`,children:`Today`}):(0,N.jsxs)(`span`,{className:`badge bg-neutral-800 text-neutral-300`,children:[`Due `,e.deadline]}):null}function dt(e){e.preventDefault();let t=e.clientX,n=oe;function r(e){let r=e.clientX-t;k(Math.min(520,Math.max(240,n+r)))}function i(){window.removeEventListener(`pointermove`,r),window.removeEventListener(`pointerup`,i),document.body.style.userSelect=``,document.body.style.cursor=``}document.body.style.userSelect=`none`,document.body.style.cursor=`col-resize`,window.addEventListener(`pointermove`,r),window.addEventListener(`pointerup`,i)}function ft(e){e.preventDefault();let t=e.clientX,n=A;function r(e){let r=t-e.clientX;se(Math.min(620,Math.max(320,n+r)))}function i(){window.removeEventListener(`pointermove`,r),window.removeEventListener(`pointerup`,i),document.body.style.userSelect=``,document.body.style.cursor=``}document.body.style.userSelect=`none`,document.body.style.cursor=`col-resize`,window.addEventListener(`pointermove`,r),window.addEventListener(`pointerup`,i)}return(0,N.jsxs)(`div`,{className:`h-screen overflow-hidden bg-neutral-950 p-4 text-neutral-100`,children:[(0,N.jsxs)(`div`,{className:`app-root`,children:[(0,N.jsx)(Xn,{panelWidth:oe,tab:n,setTab:r,search:g,setSearch:v,tagFilter:y,setTagFilter:b,allTags:Me,hideCompleted:S,setHideCompleted:C,showDisabled:w,setShowDisabled:ee,quests:Ne,activeQuestId:e.activeQuestId,dueBadge:ct,createQuest:Pe,exportJson:et,importJsonFile:at,exportQuestFile:tt,importQuestFile:nt,hasActiveQuest:!!xe,resetToDefaults:ot,selectQuest:e=>ke({type:`quest`,id:e.id})}),(0,N.jsx)(`div`,{className:`column-splitter`,onPointerDown:dt,title:`Drag to resize Library`}),(0,N.jsx)(Zn,{activePanelId:i,setActivePanelId:a,quest:xe,focusBoard:Oe,focusPathInfo:Se,setBranchFocus:We,clearBranchFocus:Ke,selectQuest:e=>{Ue(e.id),ke({type:`quest`,id:e.id})},selectTask:e=>ke({type:`task`,questId:xe.id,id:e.id}),toggleTask:e=>{let t=e.task||e;return Jn(e)?Je(xe.id):Ve(xe.id,t.id)},uncompleteTask:e=>{let t=e.task||e;return Jn(e)?Xe(xe.id):He(xe.id,t.id)},expandedKanbanCards:de,setExpandedKanbanCards:j}),(0,N.jsx)(`div`,{className:`column-splitter`,onPointerDown:ft,title:`Drag to resize Inspector / Tree column`}),(0,N.jsx)(er,{panelWidth:A,topRightTab:o,setTopRightTab:s,bottomRightTab:c,setBottomRightTab:l,selection:u,data:e,setData:t,setSelection:ke,allTags:Me,activeQuest:xe,expanded:te,setExpanded:re,rightSplit:ie,setRightSplit:ae,goBack:Ae,goForward:je,canGoBack:m>0,canGoForward:m<f.length-1,makeFocus:Ue,activeQuestId:e.activeQuestId,activeBranchTaskId:e.activeBranchTaskId,setBranchFocus:We,clearBranchFocus:Ke,completeQuest:Je,restoreQuest:Xe,createQuestTask:Fe,deleteQuest:Ie,deleteQuestTask:Le,moveQuestTask:Re,moveQuestTaskToLocation:ze,toggleTask:Ve,runMaintenanceNow:st,debugDateOverrideEnabled:pe,setDebugDateOverrideEnabled:me,debugDateOverrideDate:he,setDebugDateOverrideDate:ge,currentAppDate:ve()})]}),(0,N.jsx)(tr,{})]})}function Xn({panelWidth:e,tab:t,setTab:n,search:r,setSearch:i,tagFilter:a,setTagFilter:o,allTags:s,hideCompleted:c,setHideCompleted:l,showDisabled:u,setShowDisabled:d,quests:f,activeQuestId:p,dueBadge:m,createQuest:h,exportJson:g,importJsonFile:_,exportQuestFile:v,importQuestFile:y,hasActiveQuest:b,resetToDefaults:x,selectQuest:S}){let C=[{id:F.QUEST_BOARD,title:`Quest Board`,content:(0,N.jsx)(Kt,{search:r,setSearch:i,tagFilter:a,setTagFilter:o,allTags:s,hideCompleted:c,setHideCompleted:l,showDisabled:u,setShowDisabled:d,quests:f,activeQuestId:p,dueBadge:m,createQuest:h,selectQuest:S})},{id:F.EXPORT_PANEL,title:`Save/Load`,content:(0,N.jsx)(qt,{exportJson:g,importJsonFile:_,exportQuestFile:v,importQuestFile:y,hasActiveQuest:b,resetToDefaults:x})}];return(0,N.jsx)(Gn,{dockId:Kn.TOP_LEFT,tabs:C,activePanelId:t,onActivePanelChange:n,className:`library-col`,style:{flexBasis:`${e}px`}})}function Zn({activePanelId:e,setActivePanelId:t,...n}){let r=[{id:F.FOCUS_PANEL||`focusPanel`,title:`Focus`,content:(0,N.jsx)(Xt,{...n})}];return(0,N.jsx)(Gn,{dockId:Kn.CENTER||`center`,tabs:r,activePanelId:e,onActivePanelChange:t,panelClassName:`center-dock-wrapper`})}function Qn({activePanelId:e,setActivePanelId:t,rightSplit:n,inspectorProps:r,debugProps:i}){let a=[{id:F.INSPECTOR_PANEL,title:`Inspector`,content:(0,N.jsx)(In,{...r,embedded:!0})},{id:F.DEBUG_PANEL,title:`Debug`,content:(0,N.jsx)(Jt,{...i})}];return(0,N.jsx)(Gn,{dockId:Kn.TOP_RIGHT,tabs:a,activePanelId:e,onActivePanelChange:t,panelClassName:`top-right-dock-wrapper`,style:{flexBasis:`calc(${n}% - ${qn})`}})}function $n({activePanelId:e,setActivePanelId:t,rightSplit:n,treePanelProps:r}){let i=[{id:F.TREE_VIEW_PANEL,title:`Tree View`,content:(0,N.jsx)(on,{...r,embedded:!0})}];return(0,N.jsx)(Gn,{dockId:Kn.BOTTOM_RIGHT,tabs:i,activePanelId:e,onActivePanelChange:t,panelClassName:`bottom-right-dock-wrapper`,style:{flexBasis:`calc(${100-n}% - ${qn})`}})}function er(e){let{panelWidth:t,topRightTab:n,setTopRightTab:r,bottomRightTab:i,setBottomRightTab:a,selection:o,data:s,activeQuest:c,expanded:l,setExpanded:u,rightSplit:d,setRightSplit:f,setSelection:p,createQuestTask:m,deleteQuestTask:h,moveQuestTask:g,moveQuestTaskToLocation:v,toggleTask:y,runMaintenanceNow:b,debugDateOverrideEnabled:x,setDebugDateOverrideEnabled:S,debugDateOverrideDate:C,setDebugDateOverrideDate:w,currentAppDate:ee}=e,te=ft(o,s,c),ne=(0,_.useRef)(null);function T(e){e.preventDefault();let t=e.clientY,n=d,r=ne.current?.getBoundingClientRect()?.height||1;function i(e){let i=(e.clientY-t)/r*100;f(Math.min(82,Math.max(28,n+i)))}function a(){window.removeEventListener(`pointermove`,i),window.removeEventListener(`pointerup`,a),document.body.style.userSelect=``,document.body.style.cursor=``}document.body.style.userSelect=`none`,document.body.style.cursor=`row-resize`,window.addEventListener(`pointermove`,i),window.addEventListener(`pointerup`,a)}return(0,N.jsxs)(`aside`,{className:`right-column`,ref:ne,style:{flexBasis:`${t}px`},children:[(0,N.jsx)(Qn,{activePanelId:n,setActivePanelId:r,rightSplit:d,inspectorProps:e,debugProps:{debugDateOverrideEnabled:x,setDebugDateOverrideEnabled:S,debugDateOverrideDate:C,setDebugDateOverrideDate:w,currentAppDate:ee,runMaintenanceNow:b}}),(0,N.jsx)(`div`,{className:`right-splitter`,onPointerDown:T,title:`Drag to resize Inspector / Tree View`}),(0,N.jsx)($n,{activePanelId:i,setActivePanelId:a,rightSplit:d,treePanelProps:{treeContext:te,rightSplit:d,selection:o,expanded:l,setExpanded:u,setSelection:p,createQuestTask:m,deleteQuestTask:h,moveQuestTask:g,moveQuestTaskToLocation:v,toggleTask:y}})]})}function tr(){let e=`rgb(30 30 30)`,t=`rgb(120 120 120)`;return(0,N.jsx)(`style`,{children:`
      html, body, #root {
        height: 100%;
        margin: 0;
        overflow: hidden;
...
.focus-card-action-complete {
    ...
    `})}(0,v.createRoot)(document.getElementById(`root`)).render((0,N.jsx)(_.StrictMode,{children:(0,N.jsx)(Yn,{})}));